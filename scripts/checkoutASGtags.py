...
GRL_AllGood_PeriodJ1 = "http://atlasdqm.web.cern.ch/atlasdqm/grlgen/All_Good/data15_13TeV.periodAllYear_DetStatus-v70-pro19-04_DQDefects-00-01-02_PHYS_StandardGRL_All_Good.xml"
GRL_AllGood_PeriodJ3 = "http://atlasdqm.web.cern.ch/atlasdqm/grlgen/All_Good/data15_13TeV.periodAllYear_DetStatus-v71-pro19-05_DQDefects-00-01-02_PHYS_StandardGRL_All_Good.xml"
...
#  subprocess.call(["wget","-q",GRL_AllGood_PeriodG,"-O", "xAODAnaHelpers/data/PeriodG_"+GRL_AllGood_PeriodG.split('/')[-1]])
  ...
  subprocess.call(["wget","-q",GRL_AllGood_PeriodJ1,"-O", "xAODAnaHelpers/data/PeriodJ1_"+GRL_AllGood_PeriodJ1.split('/')[-1]])
  subprocess.call(["wget","-q",GRL_AllGood_PeriodJ3,"-O", "xAODAnaHelpers/data/PeriodJ3_"+GRL_AllGood_PeriodJ3.split('/')[-1]])
