...
StatusCode MuonHists::execute(const xAOD::IParticle* particle, float eventWeight, const xAOD::EventInfo* eventInfo) {
    ...
    if(m_infoSwitch->m_isolation) {
        ...
        if( isIsoLooseTrackOnlyAcc.isAvailable(*muon) ) m_isIsolated_LooseTrackOnly->Fill(isIsoLooseTrackOnlyAcc(*muon), eventWeight); else m_isIsolated_LooseTrackOnly->Fill(-1, eventWeight); if( isIsoLooseAcc.isAvailable(*muon) ) m_isIsolated_Loose->Fill(isIsoLooseAcc(*muon), eventWeight); else m_isIsolated_Loose->Fill(-1, eventWeight); if( isIsoTightAcc.isAvailable(*muon) ) m_isIsolated_Tight->Fill(isIsoTightAcc(*muon), eventWeight); else m_isIsolated_Tight->Fill(-1, eventWeight); if( isIsoGradientAcc.isAvailable(*muon) ) m_isIsolated_Gradient->Fill(isIsoGradientAcc(*muon), eventWeight); else m_isIsolated_Gradient->Fill(-1, eventWeight); if( isIsoGradientLooseAcc.isAvailable(*muon) ) m_isIsolated_GradientLoose->Fill(isIsoGradientLooseAcc(*muon), eventWeight); else m_isIsolated_GradientLoose->Fill(-1, eventWeight); if( isIsoGradientT1Acc.isAvailable(*muon) ) m_isIsolated_GradientT1->Fill(isIsoGradientT1Acc(*muon), eventWeight); else m_isIsolated_GradientT1->Fill(-1, eventWeight); if( isIsoGradientT2Acc.isAvailable(*muon) ) m_isIsolated_GradientT2->Fill(isIsoGradientT2Acc(*muon), eventWeight); else m_isIsolated_GradientT2->Fill(-1, eventWeight); if( isIsoMU0p06Acc.isAvailable(*muon) ) m_isIsolated_MU0p06->Fill(isIsoMU0p06Acc(*muon), eventWeight); else m_isIsolated_MU0p06->Fill(-1, eventWeight); if( isIsoFixedCutLooseAcc.isAvailable(*muon) ) m_isIsolated_FixedCutLoose->Fill(isIsoFixedCutLooseAcc(*muon), eventWeight); else m_isIsolated_FixedCutLoose->Fill(-1, eventWeight); if( isIsoFixedCutTightAcc.isAvailable(*muon) ) m_isIsolated_FixedCutTight->Fill(isIsoFixedCutTightAcc(*muon), eventWeight); else m_isIsolated_FixedCutTight->Fill(-1, eventWeight); if( isIsoFixedCutTightTrackOnlyAcc.isAvailable(*muon) ) m_isIsolated_FixedCutTightTrackOnly->Fill(isIsoFixedCutTightTrackOnlyAcc(*muon), eventWeight); else m_isIsolated_FixedCutTightTrackOnly->Fill(-1, eventWeight); if( isIsoUserDefinedFixEfficiencyAcc.isAvailable(*muon) ) m_isIsolated_UserDefinedFixEfficiency->Fill(isIsoUserDefinedFixEfficiencyAcc(*muon), eventWeight); else m_isIsolated_UserDefinedFixEfficiency->Fill(-1, eventWeight); if( isIsoUserDefinedCutAcc.isAvailable(*muon) ) m_isIsolated_UserDefinedCut->Fill(isIsoUserDefinedCutAcc(*muon), eventWeight); else m_isIsolated_UserDefinedCut->Fill(-1, eventWeight);
    ...
    if(m_infoSwitch->m_quality) {
        ...
        if( isVeryLooseQAcc.isAvailable(*muon) ) m_isVeryLoose->Fill(static_cast<int>( isVeryLooseQAcc(*muon) ), eventWeight); else m_isVeryLoose->Fill(-1, eventWeight); if( isLooseQAcc.isAvailable(*muon) ) m_isLoose    ->Fill(static_cast<int>( isLooseQAcc(*muon) ), eventWeight); else m_isLoose->Fill(-1, eventWeight); if( isMediumQAcc.isAvailable(*muon) ) m_isMedium   ->Fill(static_cast<int>( isMediumQAcc(*muon) ), eventWeight); else m_isMedium->Fill(-1, eventWeight); if( isTightQAcc.isAvailable(*muon) ) m_isTight    ->Fill(static_cast<int>( isTightQAcc(*muon) ), eventWeight); else m_isTight->Fill(-1, eventWeight);
    }
