...
MuonHists::MuonHists(std::string        name,
...
StatusCode MuonHists::initialize() {
  ...
  if (m_infoSwitch->m_isolation) {
    m_isIsolated_LooseTrackOnly = book(m_name,
                                       "isIsolated_LooseTrackOnly",
                                       "isIsolated_LooseTrackOnly",
                                       3,
                                       -1.5,
                                       1.5);
    m_isIsolated_Loose = book(m_name,
                              "isIsolated_Loose",
                              "isIsolated_Loose",
                              3,
                              -1.5,
                              1.5);
    m_isIsolated_Tight = book(m_name,
                              "isIsolated_Tight",
                              "isIsolated_Tight",
                              3,
                              -1.5,
                              1.5);
    m_isIsolated_Gradient = book(m_name,
                                 "isIsolated_Gradient",
                                 "isIsolated_Gradient",
                                 3,
                                 -1.5,
                                 1.5);
    m_isIsolated_GradientLoose = book(m_name,
                                      "isIsolated_GradientLoose",
                                      "isIsolated_GradientLoose",
                                      3,
                                      -1.5,
                                      1.5);
    m_isIsolated_GradientT1 = book(m_name,
                                   "isIsolated_GradientT1",
                                   "isIsolated_GradientT1",
                                   3,
                                   -1.5,
                                   1.5);
    m_isIsolated_GradientT2 = book(m_name,
                                   "isIsolated_GradientT2",
                                   "isIsolated_GradientT2",
                                   3,
                                   -1.5,
                                   1.5);
    m_isIsolated_MU0p06 = book(m_name,
                               "isIsolated_MU0p06",
                               "isIsolated_MU0p06",
                               3,
                               -1.5,
                               1.5);
    m_isIsolated_FixedCutLoose = book(m_name,
                                      "isIsolated_FixedCutLoose",
                                      "isIsolated_FixedCutLoose",
                                      3,
                                      -1.5,
                                      1.5);
    m_isIsolated_FixedCutTight = book(m_name,
                                      "isIsolated_FixedCutTight",
                                      "isIsolated_FixedCutTight",
                                      3,
                                      -1.5,
                                      1.5);
    m_isIsolated_FixedCutTightTrackOnly = book(m_name,
                                               "isIsolated_FixedCutTightTrackOnly",
                                               "isIsolated_FixedCutTightTrackOnly",
                                               3,
                                               -1.5,
                                               1.5);
    m_isIsolated_UserDefinedFixEfficiency = book(m_name,
                                                 "isIsolated_UserDefinedFixEfficiency",
                                                 "isIsolated_UserDefinedFixEfficiency",
                                                 3,
                                                 -1.5,
                                                 1.5);
    m_isIsolated_UserDefinedCut = book(m_name,
    ...
    m_ptcone20_rel = book(m_name,
                          "ptcone20_rel",
                          "ptcone20_rel",
                          110,
                          -0.2,
                          2);
    m_ptcone30_rel = book(m_name,
                          "ptcone30_rel",
                          "ptcone30_rel",
                          110,
                          -0.2,
                          2);
    m_ptcone40_rel = book(m_name,
                          "ptcone40_rel",
                          "ptcone40_rel",
                          110,
                          -0.2,
                          2);
    m_ptvarcone20_rel = book(m_name,
                             "ptvarcone20_rel",
                             "ptvarcone20_rel",
                             110,
                             -0.2,
                             2);
    m_ptvarcone30_rel = book(m_name,
                             "ptvarcone30_rel",
                             "ptvarcone30_rel",
                             110,
                             -0.2,
                             2);
    m_ptvarcone40_rel = book(m_name,
                             "ptvarcone40_rel",
                             "ptvarcone40_rel",
                             110,
                             -0.2,
                             2);
    m_topoetcone20_rel = book(m_name,
                              "topoetcone20_rel",
                              "topoetcone20_rel",
                              110,
                              -0.2,
                              2);
    m_topoetcone30_rel = book(m_name,
                              "topoetcone30_rel",
                              "topoetcone30_rel",
                              110,
                              -0.2,
                              2);
    m_topoetcone40_rel = book(m_name,
                              "topoetcone40_rel",
                              "topoetcone40_rel",
                              110,
                              -0.2,
...
StatusCode MuonHists::execute(const xAOD::Muon      *muon,
                              float                  eventWeight,
                              const xAOD::EventInfo *eventInfo) {
  return execute(static_cast<const xAOD::IParticle *>(muon),
                 eventWeight,
                 eventInfo);
}

StatusCode MuonHists::execute(const xAOD::IParticle *particle,
                              float                  eventWeight,
                              const xAOD::EventInfo *eventInfo) {
  ...
  if (muon == 0)
  {
    ::Error("MuonHists::execute()",
            XAOD_MESSAGE("Cannot convert IParticle to Muon"));
  ...
  if (m_infoSwitch->m_isolation) {
    ...
    static SG::AuxElement::Accessor<char> isIsoGradientLooseAcc(
      "isIsolated_GradientLoose");
    static SG::AuxElement::Accessor<char> isIsoGradientT1Acc(
      "isIsolated_GradientT1");
    static SG::AuxElement::Accessor<char> isIsoGradientT2Acc(
      "isIsolated_GradientT2");
    ...
    static SG::AuxElement::Accessor<char> isIsoFixedCutLooseAcc(
      "isIsolated_FixedCutLoose");
    static SG::AuxElement::Accessor<char> isIsoFixedCutTightAcc(
      "isIsolated_FixedCutTight");
    ...
    if (isIsoLooseTrackOnlyAcc.isAvailable(*muon)) m_isIsolated_LooseTrackOnly->
      Fill(isIsoLooseTrackOnlyAcc(*muon), eventWeight);
    else m_isIsolated_LooseTrackOnly->Fill(-1,  eventWeight);

    if (isIsoLooseAcc.isAvailable(*muon)) m_isIsolated_Loose->Fill(isIsoLooseAcc(*
                                                                                 muon),
                                                                   eventWeight);
    else m_isIsolated_Loose->Fill(-1,  eventWeight);

    if (isIsoTightAcc.isAvailable(*muon)) m_isIsolated_Tight->Fill(isIsoTightAcc(*
                                                                                 muon),
                                                                   eventWeight);
    else m_isIsolated_Tight->Fill(-1,  eventWeight);

    if (isIsoGradientAcc.isAvailable(*muon)) m_isIsolated_Gradient->Fill(isIsoGradientAcc(
                                                                           *muon),
                                                                         eventWeight);

    else m_isIsolated_Gradient->Fill(-1,  eventWeight);

    if (isIsoGradientLooseAcc.isAvailable(*muon)) m_isIsolated_GradientLoose->Fill(isIsoGradientLooseAcc(
                                                                                     *
                                                                                     muon),
                                                                                   eventWeight);

    else m_isIsolated_GradientLoose->Fill(-1,  eventWeight);

    if (isIsoGradientT1Acc.isAvailable(*muon)) m_isIsolated_GradientT1->Fill(isIsoGradientT1Acc(
                                                                               *
                                                                               muon),
                                                                             eventWeight);
    else m_isIsolated_GradientT1->Fill(-1,  eventWeight);

    if (isIsoGradientT2Acc.isAvailable(*muon)) m_isIsolated_GradientT2->Fill(isIsoGradientT2Acc(
                                                                               *
                                                                               muon),
                                                                             eventWeight);
    else m_isIsolated_GradientT2->Fill(-1,  eventWeight);

    if (isIsoMU0p06Acc.isAvailable(*muon)) m_isIsolated_MU0p06->Fill(isIsoMU0p06Acc(
                                                                       *muon),
                                                                     eventWeight);
    else m_isIsolated_MU0p06->Fill(-1,  eventWeight);

    if (isIsoFixedCutLooseAcc.isAvailable(*muon)) m_isIsolated_FixedCutLoose->Fill(isIsoFixedCutLooseAcc(
        *muon),
      eventWeight); else m_isIsolated_FixedCutLoose->Fill(-1,  eventWeight);
...
StatusCode MuonHists::execute(const xAH::Particle *particle, float eventWeight, const xAH::EventInfo * /*eventInfo*/) {
  ...
  if (m_infoSwitch->m_isolation) {
    ...
    // m_isIsolated_GradientT1               ->Fill(
    // muon->isIsolated_GradientLoose ,  eventWeight );
    // m_isIsolated_GradientT2               ->Fill( muon->isIsoGradientT2Acc ,
    //  eventWeight );
    // m_isIsolated_MU0p06                   ->Fill( muon->isIsoMU0p06Acc ,
    //  eventWeight );
    m_isIsolated_FixedCutLoose->Fill(muon->isIsolated_FixedCutLoose, eventWeight);

    // m_isIsolated_FixedCutTight            ->Fill(
    // muon->isIsolated_FixedCutTight ,  eventWeight );
