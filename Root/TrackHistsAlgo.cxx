...
EL::StatusCode TrackHistsAlgo::histInitialize()
{
  ...
  if (m_inContainerName.empty() || m_detailStr.empty()) {
    Error("histInitialize()",
          "One or more required configuration values are empty");
...
EL::StatusCode TrackHistsAlgo::fileExecute() {
  return EL::StatusCode::SUCCESS;
}

EL::StatusCode TrackHistsAlgo::changeInput(bool /*firstFile*/) {
  return EL::StatusCode::SUCCESS;
}
...
EL::StatusCode TrackHistsAlgo::execute()
{
  ...
  RETURN_CHECK("TrackHistsAlgo::execute()",
  ...
  RETURN_CHECK("TrackHistsAlgo::execute()",
               HelperFunctions::retrieve(tracks,
                                         m_inContainerName,
                                         m_event,
                                         m_store,
                                         m_verbose), "");
...
EL::StatusCode TrackHistsAlgo::postExecute() {
  return EL::StatusCode::SUCCESS;
}

EL::StatusCode TrackHistsAlgo::finalize() {
  return EL::StatusCode::SUCCESS;
}
