...
StatusCode JetHists::initialize() {
  ...
  if (m_infoSwitch->m_clean) {
    ...
    // units?
    m_jetTime = book(m_name,
                     "JetTimming",
                     m_titlePrefix + "Jet Timming",
                     120,
                     -80,
                     80);
    m_LArQuality = book(m_name,
                        "LArQuality",
                        m_titlePrefix + "LAr Quality",
                        120,
                        -600,
                        600);
    m_hecq = book(m_name,
                  "HECQuality",
                  m_titlePrefix + "HEC Quality",
                  120,
                  -10,
                  10);
    m_negE = book(m_name,
                  "NegativeE",
                  m_titlePrefix + "Negative Energy",
                  120,
                  -10,
                  10);
    m_avLArQF = book(m_name,
                     "AverageLArQF",
                     m_titlePrefix + "<LAr Quality Factor>",
                     120,
                     0,
                     1000);
    m_bchCorrCell = book(m_name,
                         "BchCorrCell",
                         m_titlePrefix + "BCH Corr Cell",
                         120,
                         0,
                         600);
    m_N90Const = book(m_name,
                      "N90Constituents",
                      m_titlePrefix + "N90 Constituents",
                      120,
                      0,
                      40);

    // m_LArBadHVEFrac              =book(m_name, "LArBadHVEFrac",
    //              m_titlePrefix+" jet LAr Bad HV Energy Fraction", 120,   0,
    //    1);
    // m_LArBadHVNCell              =book(m_name, "LArBadHVNCell",
    //              m_titlePrefix+" jet LAr Bad HV N_{cells}",       120,
    //  -0.5,499.5);
    // m_OotFracClusters5           =book(m_name, "OotFracClusters5",
    //           m_titlePrefix+" jet OotFracClusters5" ,          120,   0,
    //    1);
    // m_OotFracClusters10          =book(m_name, "OotFracClusters10",
    //          m_titlePrefix+" jet OotFracClusters10" ,         120,   0,
    //    1);
    // m_LeadingClusterPt           =book(m_name, "LeadingClusterPt",
    //           m_titlePrefix+" jet Leading Cluster P_{T}" ,     120,   0,
    // 1000);
    // m_LeadingClusterSecondLambda =book(m_name, "LeadingClusterSecondLambda",
    // m_titlePrefix+" jet LeadingClusterSecondLambda", 120,   0, 1000e3);
    // m_LeadingClusterCenterLambda =book(m_name, "LeadingClusterCenterLambda",
    // m_titlePrefix+" jet LeadingClusterCenterLambda", 120,   0, 5000);
    // m_LeadingClusterSecondR      =book(m_name, "LeadingClusterSecondR",
    //      m_titlePrefix+" jet LeadingClusterSecondR" ,     120,   0, 300e3);
    // m_clean_passLooseBad         =book(m_name, "clean_passLooseBad",
    //         m_titlePrefix+" jet LooseBad Cleaning Flag" ,      2,  -0.5,
    //  1.5);
    // m_clean_passLooseBadUgly     =book(m_name, "clean_passLooseBadUgly",
    //     m_titlePrefix+" jet LooseBadUgly Cleaning Flag",   2,  -0.5,  1.5);
    // m_clean_passTightBad         =book(m_name, "clean_passTightBad",
    //         m_titlePrefix+" jet TightBad Cleaning Flag" ,      2,  -0.5,
    //  1.5);
    // m_clean_passTightBadUgly     =book(m_name, "clean_passTightBadUgly",
    //     m_titlePrefix+" jet TightBadUgly Cleaning Flag",   2,  -0.5,  1.5);
  }
  ...
  if (m_infoSwitch->m_energy) {
    ...
    m_HECf = book(m_name,
                  "HECFrac",
                  m_titlePrefix + "HEC Fraction",
                  120,
                  0,
                  5);
    m_EMf = book(m_name,
                 "EMFrac",
                 m_titlePrefix + "EM Fraction",
                 120,
                 0,
                 2);
    m_actArea = book(m_name,
                     "ActiveArea",
                     m_titlePrefix + "Jet Active Area",
                     120,
                     0,
                     1);
    m_centroidR = book(m_name,
                       "CentroidR",
                       m_titlePrefix + "CentroidR",
                       120,
                       0,
                       600);

    // m_FracSamplingMax       = book(m_name, "FracSamplingMax",
    //       m_titlePrefix+" jet FracSamplingMax" ,       120,  0,      1);
    // m_FracSamplingMaxIndex  = book(m_name, "FracSamplingMaxIndex",
    //  m_titlePrefix+" jet FracSamplingMaxIndex" ,   22, -0.5,   21.5);
    // m_LowEtConstituentsFrac = book(m_name, "LowEtConstituentsFrac",
    // m_titlePrefix+" jet LowEtConstituentsFrac" , 120,  0,      1);
    // m_GhostMuonSegmentCount = book(m_name, "GhostMuonSegmentCount",
    // m_titlePrefix+" jet GhostMuonSegmentCount" ,  10, -0.5,    9.5);
    // m_Width                 = book(m_name, "Width",
    //                 m_titlePrefix+" jet Width",                  100, 0,
    // 0.5);
  }
  ...
  if (m_infoSwitch->m_layer) {
    ...
    m_TileExt0 = book(m_name,
                      "TileExt0",
                      "Tile extended barrel  0",
                      120,
                      -0.1,
                      1.1);
    m_TileExt1 = book(m_name,
                      "TileExt1",
                      "Tile extended barrel  1",
                      120,
                      -0.1,
                      1.1);
    m_TileExt2 = book(m_name,
                      "TileExt2",
                      "Tile extended barrel  2",
                      120,
                      -0.1,
                      1.1);
  ...
  if (m_infoSwitch->m_resolution) {
    ...
    // 1D
    m_jetGhostTruthPt = book(m_name,
                             "jetGhostTruthPt",
                             "jet ghost truth p_{T} [GeV]",
                             120,
                             0,
                             600);
    ...
    m_jetGhostTruthPt_vs_resolution = book(m_name,
                                           "jetGhostTruthPt_vs_resolution",
                                           "jet ghost truth p_{T} [GeV]",
                                           120,
                                           0,
                                           600,
  ...
  if (m_infoSwitch->m_truth) {
    ...
    m_truthLabelID = book(m_name,
                          "TruthLabelID",
                          m_titlePrefix + "Truth Label",
                          40,
                          -10.5,
                          29.5);
    m_hadronConeExclTruthLabelID = book(m_name,
                                        "HadronConeExclTruthLabelID",
                                        m_titlePrefix + "HadronConeExclTruthLabelID",
                                        40,
                                        -10.5,
                                        29.5);
    m_truthCount = book(m_name,
                        "TruthCount",
                        m_titlePrefix + "Truth Count",
                        60,
                        -10.5,
                        49.5);
    m_truthPt = book(m_name,
                     "TruthPt",
                     m_titlePrefix + "Truth Pt",
                     100,
                     0,
                     100.0);

    m_truthDr_B = book(m_name,
                       "TruthLabelDeltaR_B",
                       m_titlePrefix + "Truth Label dR(b)",
                       120,
                       -0.1,
                       1.0);
    m_truthDr_C = book(m_name,
                       "TruthLabelDeltaR_C",
                       m_titlePrefix + "Truth Label dR(c)",
                       120,
                       -0.1,
                       1.0);
    m_truthDr_T = book(m_name,
                       "TruthLabelDeltaR_T",
                       m_titlePrefix + "Truth Label dR(tau)",
                       120,
                       -0.1,
                       1.0);

    // m_PartonTruthLabelID= book(m_name, "PartonTruthLabelID",
    // m_titlePrefix+"jet PartonTruthLabelID",  22, -0.5, 21.5);
    // m_GhostTruthAssociationFraction= book(m_name,
    // "GhostTruthAssociationFraction", m_titlePrefix+" jet
    // GhostTruthAssociationFraction", 100, 0, 1);
    // m
    // m_truth_pt_m = book(m_name, "truth_pt_m"  , m_titlePrefix+" jet truth
    // p_{T} [GeV]", 100, 0, 1000);
    // m_truth_pt_l = book(m_name, "truth_pt_l"  , m_titlePrefix+" jet truth
    // p_{T} [GeV]", 100, 0, 5000);
    // m
    // m_truth_eta  = book(m_name, "truth_eta"   , m_titlePrefix+" jet truth
    // #eta", 100, -3          , 3);
    // m_truth_phi  = book(m_name, "truth_phi"   , m_titlePrefix+" jet truth
    // #phi", 100, -TMath::Pi(), TMath::Pi());
  }

  if (m_infoSwitch->m_truthDetails) {
    if (m_debug) Info("JetHists::initialize()", "adding detailed truth plots");

    m_truthCount_BhadFinal = book(m_name,
                                  "GhostBHadronsFinalCount",
                                  "Truth Count BHad (final)",
                                  10,
                                  -0.5,
                                  9.5);
    m_truthCount_BhadInit = book(m_name,
                                 "GhostBHadronsInitialCount",
                                 "Truth Count BHad (initial)",
                                 10,
                                 -0.5,
                                 9.5);
    m_truthCount_BQFinal = book(m_name,
                                "GhostBQuarksFinalCount",
                                "Truth Count BQuark (final)",
                                10,
                                -0.5,
                                9.5);
    m_truthPt_BhadFinal = book(m_name,
                               "GhostBHadronsFinalPt",
                               "Truth p_{T} BHad (final)",
                               100,
                               0,
                               100);
    m_truthPt_BhadInit = book(m_name,
                              "GhostBHadronsInitialPt",
                              "Truth p_{T} BHad (initial)",
                              100,
                              0,
                              100);
    m_truthPt_BQFinal = book(m_name,
                             "GhostBQuarksFinalPt",
                             "Truth p_{T} BQuark (final)",
                             100,
                             0,
                             100);

    m_truthCount_ChadFinal = book(m_name,
                                  "GhostCHadronsFinalCount",
                                  "Truth Count CHad (final)",
                                  10,
                                  -0.5,
                                  9.5);
    m_truthCount_ChadInit = book(m_name,
                                 "GhostCHadronsInitialCount",
                                 "Truth Count CHad (initial)",
                                 10,
                                 -0.5,
                                 9.5);
    m_truthCount_CQFinal = book(m_name,
                                "GhostCQuarksFinalCount",
                                "Truth Count CQuark (final)",
                                10,
                                -0.5,
                                9.5);
    m_truthPt_ChadFinal = book(m_name,
                               "GhostCHadronsFinalPt",
                               "Truth p_{T} CHad (final)",
                               100,
                               0,
                               100);
    m_truthPt_ChadInit = book(m_name,
                              "GhostCHadronsInitialPt",
                              "Truth p_{T} CHad (initial)",
                              100,
                              0,
                              100);
    m_truthPt_CQFinal = book(m_name,
                             "GhostCQuarksFinalPt",
                             "Truth p_{T} CQuark (final)",
                             100,
                             0,
                             100);

    m_truthCount_TausFinal = book(m_name,
                                  "GhostTausFinalCount",
                                  "Truth Count Taus (final)",
                                  10,
                                  -0.5,
                                  9.5);
    m_truthPt_TausFinal = book(m_name,
                               "GhostTausFinalPt",
                               "Truth p_{T} Taus (final)",
                               100,
                               0,
                               100);
  }
  ...
  if (m_infoSwitch->m_flavTag || m_infoSwitch->m_flavTagHLT) {
    ...
    m_MV2c00 = book(m_name,
                    "MV2c00",
                    m_titlePrefix + "MV2c00",
                    100,
                    -1.1,
                    1.1);
    m_MV2c10 = book(m_name,
                    "MV2c10",
                    m_titlePrefix + "MV2c10",
                    100,
                    -1.1,
                    1.1);
    m_MV2c20 = book(m_name,
                    "MV2c20",
                    m_titlePrefix + "MV2c20",
                    100,
                    -1.1,
                    1.1);
    m_MV2c20_l = book(m_name,
                      "MV2c20_l",
                      m_titlePrefix + "MV2c20",
                      500,
                      -1.1,
    ...
    m_COMB = book(m_name,
                  ...
                  -20,
                  40);
    m_JetFitter = book(m_name,
                       "JetFitter",
                       m_titlePrefix + "JetFitter",
                       100,
                       -10,
                       10);
    m_JetFitterCombNN = book(m_name,
                             "JetFitterCombNN",
                             m_titlePrefix + "JetFitterCombNN",
                             100,
                             -10,
                             10);

    // m_MV2           = book(m_name, "MV2",               m_titlePrefix+" jet
    // MV2"          , 100,   -1  ,  1);
    // m_IP3DvsMV2c20  = book(m_name, "IP3DvsMV2c20",      m_titlePrefix+" jet
    // MV2c20"       , 100,   -1  ,  1,


    if (m_infoSwitch->m_vsLumiBlock) {
      m_frac_MV2c2040_vs_lBlock = book(m_name,
                                       "frac_MV2c2040_vs_lBlock",
                                       "LumiBlock",
                                       200,
                                       0,
                                       2000,
                                       ...
                                       0,
                                       1);
      m_frac_MV2c2050_vs_lBlock = book(m_name,
                                       "frac_MV2c2050_vs_lBlock",
                                       "LumiBlock",
                                       200,
                                       0,
                                       2000,
                                       ...
                                       0,
                                       1);
      m_frac_MV2c2060_vs_lBlock = book(m_name,
                                       "frac_MV2c2060_vs_lBlock",
                                       "LumiBlock",
                                       200,
                                       0,
                                       2000,
                                       ...
                                       0,
                                       1);
      m_frac_MV2c2070_vs_lBlock = book(m_name,
                                       "frac_MV2c2070_vs_lBlock",
                                       "LumiBlock",
                                       200,
                                       0,
                                       2000,
                                       ...
                                       0,
                                       1);
      m_frac_MV2c2077_vs_lBlock = book(m_name,
                                       "frac_MV2c2077_vs_lBlock",
                                       "LumiBlock",
                                       200,
                                       0,
                                       2000,
                                       ...
                                       0,
                                       1);
      m_frac_MV2c2085_vs_lBlock = book(m_name,
                                       "frac_MV2c2085_vs_lBlock",
                                       "LumiBlock",
                                       200,
                                       0,
                                       2000,
  ...
  if (m_infoSwitch->m_btag_jettrk) {
    m_trkSum_ntrk = book(m_name,
                         "trkSum_ntrk",
                         "trkSum_ntrk",
                         40,
                         -0.5,
                         39.5);
    m_trkSum_sPt = book(m_name,
                        "trkSum_sPt",
                        "trkSum_sPt",
                        100,
                        -10,
                        200.0);
    m_trkSum_vPt = book(m_name,
                        "trkSum_vPt",
                        "trkSum_vPt",
                        100,
                        -10,
                        200.0);
    m_trkSum_vAbsEta = book(m_name,
                            "trkSum_vAbsEta",
                            "trkSum_vAbsEta",
                            50,
                            -0.1,
    ...
    m_width = book(m_name,
                   ...
                   -0.1,
                   0.5);
    m_n_trk_sigd0cut = book(m_name,
                            "n_trk_sigd0cut",
                            "n_trk_sigd0cut",
                            30,
                            -0.5,
                            29.5);
    m_trk3_d0sig = book(m_name,
                        "trk3_d0sig",
                        "trk3_d0sig",
                        100,
                        -20.,
                        20.0);
    m_trk3_z0sig = book(m_name,
                        "trk3_z0sig",
                        "trk3_z0sig",
                        100,
                        -20.,
                        20.0);
    m_sv_scaled_efc = book(m_name,
                           "sv_scaled_efc",
                           "sv_scaled_efc",
                           100,
                           -0.1,
                           10.1);
    m_jf_scaled_efc = book(m_name,
                           "jf_scaled_efc",
                           "jf_scaled_efc",
                           100,
                           -0.1,
  ...
  if (m_infoSwitch->m_jetFitterDetails) {
    ...
    m_jf_nVTX = book(m_name,
                     "JetFitter_nVTX",
                     "JetFitter_nVTX",
                     10,
                     -0.5,
                     9.5);
    m_jf_nSingleTracks = book(m_name,
                              "JetFitter_nSingleTracks",
                              "JetFitter_nSingleTracks",
                              10,
                              -0.5,
                              9.5);
    m_jf_nTracksAtVtx = book(m_name,
                             "JetFitter_nTracksAtVtx",
                             "JetFitter_nTracksAtVtx",
                             20,
                             -0.5,
                             19.5);
    m_jf_mass = book(m_name,
                     "JetFitter_mass",
                     "JetFitter_mass",
                     100,
                     0,
                     10);
    m_jf_energyFraction = book(m_name,
                               "JetFitter_energyFraction",
                               "JetFitter_energyFraction",
                               100,
                               -0.1,
                               1.1);
    m_jf_significance3d = book(m_name,
                               "JetFitter_significance3d",
                               "JetFitter_significance3d",
                               100,
                               0,
                               100);
    m_jf_deltaeta = book(m_name,
                         "JetFitter_deltaeta",
                         "JetFitter_deltaeta",
                         100,
                         -0.2,
                         0.2);
    m_jf_deltaeta_l = book(m_name,
                           "JetFitter_deltaeta_l",
                           "JetFitter_deltaeta",
                           100,
                           -0.4,
                           0.4);
    m_jf_deltaphi = book(m_name,
                         "JetFitter_deltaphi",
                         "JetFitter_deltaphi",
                         100,
                         -0.2,
                         0.2);
    m_jf_deltaR = book(m_name,
                       "JetFitter_deltaR",
                       "JetFitter_deltaR",
                       100,
                       -0.01,
                       0.5);
    m_jf_deltaphi_l = book(m_name,
                           "JetFitter_deltaphi_l",
                           "JetFitter_deltaphi",
                           100,
                           -0.4,
                           0.4);
    m_jf_N2Tpar = book(m_name,
                       "JetFitter_N2Tpair",
                       "JetFitter_N2Tpair",
                       20,
                       -0.5,
    ...
    m_jf_pu = book(m_name,
                   ...
                   -0.1,
                   1);
    m_jf_mass_unco = book(m_name,
                          "JetFitter_mass_unco",
                          "JetFitter_mass_unco",
                          100,
                          -0.1,
                          10);
    m_jf_dR_flight = book(m_name,
                          "JetFitter_dR_flight",
                          "JetFitter_dR_flight",
                          100,
                          -0.1,
  ...
  if (m_infoSwitch->m_svDetails) {
    ...
    m_SV0 = book(m_name,
                 ...
                 -20,
                 200);
    m_sv0_NGTinSvx = book(m_name,
                          "SV0_NGTinSvx",
                          "SV0_NGTinSvx",
                          20,
                          -0.5,
                          19.5);
    m_sv0_N2Tpair = book(m_name,
                         "SV0_N2Tpair ",
                         "SV0_N2Tpair ",
                         40,
                         -9.5,
                         29.5);
    m_sv0_massvx = book(m_name,
                        "SV0_massvx  ",
                        "SV0_massvx  ",
                        100,
                        -0.1,
                        8);
    m_sv0_efracsvx = book(m_name,
                          "SV0_efracsvx",
                          "SV0_efracsvx",
                          100,
                          -0.1,
                          1.2);
    m_sv0_normdist = book(m_name,
                          "SV0_normdist",
                          "SV0_normdist",
                          100,
                          -10,
    ...
    m_SV1_pu = book(m_name,
                    "SV1_pu",
                    "SV1_pu",
                    100,
                    -0.1,
                    1.1);
    m_SV1_pb = book(m_name,
                    "SV1_pb",
                    "SV1_pb",
                    100,
                    -0.1,
                    1.1);
    m_SV1_pc = book(m_name,
                    "SV1_pc",
                    "SV1_pc",
                    100,
                    -0.1,
    ...
    m_sv1_NGTinSvx = book(m_name,
                          "SV1_NGTinSvx",
                          "SV1_NGTinSvx",
                          20,
                          -0.5,
                          19.5);
    m_sv1_N2Tpair = book(m_name,
                         "SV1_N2Tpair ",
                         "SV1_N2Tpair ",
                         40,
                         -9.5,
                         29.5);
    m_sv1_massvx = book(m_name,
                        "SV1_massvx  ",
                        "SV1_massvx  ",
                        100,
                        -0.1,
                        8);
    m_sv1_efracsvx = book(m_name,
                          "SV1_efracsvx",
                          "SV1_efracsvx",
                          100,
                          -0.1,
                          1.2);
    m_sv1_normdist = book(m_name,
                          "SV1_normdist",
                          "SV1_normdist",
                          100,
                          -10,
                          70);
    m_SV1_Lxy = book(m_name,
                     "SV1_Lxy",
                     "SV1_Lxy",
                     100,
                     -1,
                     70);
    m_SV1_L3d = book(m_name,
                     "SV1_L3d",
                     "SV1_L3d",
                     100,
                     -1,
                     70);
    m_SV1_distmatlay = book(m_name,
                            "SV1_distmatlay",
                            "SV1_distmatlay",
                            100,
                            -1,
                            30);
    m_SV1_dR = book(m_name,
                    "SV1_dR",
                    "SV1_dR",
                    100,
                    -0.1,
  ...
  if (m_infoSwitch->m_ipDetails) {
    m_IP2D_pu = book(m_name,
                     "IP2D_pu",
                     "IP2D_pu",
                     100,
                     -0.1,
                     1.1);
    m_IP2D_pb = book(m_name,
                     "IP2D_pb",
                     "IP2D_pb",
                     100,
                     -0.1,
                     1.1);
    m_IP2D_pc = book(m_name,
                     "IP2D_pc",
                     "IP2D_pc",
                     100,
                     -0.1,
    ...
    m_IP2D = book(m_name,
                  ...
                  -10,
                  40);
    m_IP2D_c = book(m_name,
                    "IP2D_c",
                    "IP2D_c",
                    100,
                    -10,
                    40);
    m_IP2D_cu = book(m_name,
                     "IP2D_cu",
                     "IP2D_cu",
                     100,
                     -10,
                     40);
    m_nIP2DTracks = book(m_name,
                         "nIP2DTracks",
                         "nIP2DTracks",
                         20,
                         -0.5,
                         19.5);
    m_IP2D_gradeOfTracks = book(m_name,
                                "IP2D_gradeOfTracks",
                                "IP2D_gradeOfTracks",
                                20,
                                -0.5,
                                19.5);
    m_IP2D_flagFromV0ofTracks = book(m_name,
                                     "IP2D_flagFromV0ofTracks",
                                     "IP2D_flagFromV0ofTracks",
                                     5,
                                     -0.5,
                                     4.5);
    m_IP2D_valD0wrtPVofTracks = book(m_name,
                                     "IP2D_valD0wrtPVofTracks",
                                     "IP2D_valD0wrtPVofTracks",
                                     100,
                                     -2.0,
                                     2.0);
    m_IP2D_sigD0wrtPVofTracks = book(m_name,
                                     "IP2D_sigD0wrtPVofTracks",
                                     "IP2D_sigD0wrtPVofTracks",
                                     100,
                                     -15.0,
                                     15.0);
    m_IP2D_sigD0wrtPVofTracks_l = book(m_name,
                                       "IP2D_sigD0wrtPVofTracks_l",
                                       "IP2D_sigD0wrtPVofTracks",
                                       100,
                                       -50.0,
                                       50.0);
    m_IP2D_errD0wrtPVofTracks = book(m_name,
                                     "IP2D_errD0wrtPVofTracks",
                                     "IP2D_errD0wrtPVofTracks",
                                     100,
                                     0.0,
                                     1.0);

    m_IP2D_weightBofTracks = book(m_name,
                                  "IP2D_weightBofTracks",
                                  "IP2D_weightBofTracks",
                                  100,
                                  -0.1,
                                  1.5);
    m_IP2D_weightCofTracks = book(m_name,
                                  "IP2D_weightCofTracks",
                                  "IP2D_weightCofTracks",
                                  100,
                                  -0.1,
                                  1.5);
    m_IP2D_weightUofTracks = book(m_name,
    ...
    m_IP3D_pu = book(m_name,
                     "IP3D_pu",
                     "IP3D_pu",
                     100,
                     -0.1,
                     1.1);
    m_IP3D_pb = book(m_name,
                     "IP3D_pb",
                     "IP3D_pb",
                     100,
                     -0.1,
                     1.1);
    m_IP3D_pc = book(m_name,
                     "IP3D_pc",
                     "IP3D_pc",
                     100,
                     -0.1,
    ...
    m_IP3D = book(m_name,
                  ...
                  -20,
                  40);
    m_IP3D_c = book(m_name,
                    "IP3D_c",
                    "IP3D_c",
                    100,
                    -20,
                    40);
    m_IP3D_cu = book(m_name,
                     "IP3D_cu",
                     "IP3D_cu",
                     100,
                     -20,
                     40);
    m_nIP3DTracks = book(m_name,
                         "nIP3DTracks",
                         "nIP3DTracks",
                         20,
                         -0.5,
                         19.5);
    m_IP3D_gradeOfTracks = book(m_name,
                                "IP3D_gradeOfTracks",
                                "IP3D_gradeOfTracks",
                                20,
                                -0.5,
                                19.5);
    m_IP3D_flagFromV0ofTracks = book(m_name,
                                     "IP3D_flagFromV0ofTracks",
                                     "IP3D_flagFromV0ofTracks",
                                     5,
                                     -0.5,
                                     4.5);
    m_IP3D_valD0wrtPVofTracks = book(m_name,
                                     "IP3D_valD0wrtPVofTracks",
                                     "IP3D_valD0wrtPVofTracks",
                                     100,
                                     -2.0,
                                     2.0);
    m_IP3D_sigD0wrtPVofTracks = book(m_name,
                                     "IP3D_sigD0wrtPVofTracks",
                                     "IP3D_sigD0wrtPVofTracks",
                                     100,
                                     -15.0,
                                     15.0);
    m_IP3D_sigD0wrtPVofTracks_l = book(m_name,
                                       "IP3D_sigD0wrtPVofTracks_l",
                                       "IP3D_sigD0wrtPVofTracks",
                                       100,
                                       -50.0,
                                       50.0);
    m_IP3D_errD0wrtPVofTracks = book(m_name,
                                     "IP3D_errD0wrtPVofTracks",
                                     "IP3D_errD0wrtPVofTracks",
                                     100,
                                     0.0,
                                     1.0);

    m_IP3D_valZ0wrtPVofTracks = book(m_name,
                                     "IP3D_valZ0wrtPVofTracks",
                                     "IP3D_valZ0wrtPVofTracks",
                                     100,
                                     -2.0,
                                     2.0);
    m_IP3D_sigZ0wrtPVofTracks = book(m_name,
                                     "IP3D_sigZ0wrtPVofTracks",
                                     "IP3D_sigZ0wrtPVofTracks",
                                     100,
                                     -15.0,
                                     15.0);
    m_IP3D_sigZ0wrtPVofTracks_l = book(m_name,
                                       "IP3D_sigZ0wrtPVofTracks_l",
                                       "IP3D_sigZ0wrtPVofTracks",
                                       100,
                                       -50.0,
                                       50.0);
    m_IP3D_errZ0wrtPVofTracks = book(m_name,
                                     "IP3D_errZ0wrtPVofTracks",
                                     "IP3D_errZ0wrtPVofTracks",
                                     100,
                                     0.0,
                                     1.0);
    ...
    m_IP3D_weightBofTracks = book(m_name,
                                  "IP3D_weightBofTracks",
                                  "IP3D_weightBofTracks",
                                  100,
                                  -0.1,
                                  1.5);
    m_IP3D_weightCofTracks = book(m_name,
                                  "IP3D_weightCofTracks",
                                  "IP3D_weightCofTracks",
                                  100,
                                  -0.1,
                                  1.5);
    m_IP3D_weightUofTracks = book(m_name,
  ...
  if (m_infoSwitch->m_byEta) {
    m_jetPt_eta_0_1 = book(m_name,
                           "jetPt_eta_0_1",
                           "p_{T} [GeV]",
                           100,
                           0,
                           1000);
    m_jetPt_eta_1_2 = book(m_name,
                           "jetPt_eta_1_2",
                           "p_{T} [GeV]",
                           100,
                           0,
                           1000);
    m_jetPt_eta_2_2p5 = book(m_name,
                             "jetPt_eta_2_2p5",
                             "p_{T} [GeV]",
                             100,
                             0,
                             1000);
    m_jetPt_eta_1_2p5 = book(m_name,
                             "jetPt_eta_1_2p5",
                             "p_{T} [GeV]",
                             100,
                             0,
  ...
  if (m_infoSwitch->m_onlineBS) {
    m_bs_online_vz = book(m_name,
                          "bs_online_vz",
                          "bs_online_vz",
                          200,
                          -5,
                          5);
    m_bs_online_vz_l = book(m_name,
                            "bs_online_vz_l",
                            "bs_online_vz_l",
                            200,
                            -100,
                            100);
    m_bs_online_vy = book(m_name,
                          "bs_online_vy",
                          "bs_online_vy",
                          200,
                          -2,
                          2);
    m_bs_online_vx = book(m_name,
                          "bs_online_vx",
                          "bs_online_vx",
                          200,
                          -2,
    ...
    m_eta_bs_online_vz_0_1 = book(m_name,
                                  "eta_bs_online_vz_0_1",
                                  "Jet #eta",
                                  80,
                                  -4,
                                  4);
    m_eta_bs_online_vz_1_1p5 = book(m_name,
                                    "eta_bs_online_vz_1_1p5",
                                    "Jet #eta",
                                    80,
                                    -4,
                                    4);
    m_eta_bs_online_vz_1p5_2 = book(m_name,
                                    "eta_bs_online_vz_1p5_2",
                                    "Jet #eta",
                                    80,
                                    -4,
                                    4);
  ...
  if (m_infoSwitch->m_hltVtxComp) {
    m_vtx_offline_x0 = book(m_name,
                            "vtx_offline_x0",
                            "vtx_offline_x0",
                            100,
                            -0.2,
                            0.2);
    m_vtx_offline_y0 = book(m_name,
                            "vtx_offline_y0",
                            "vtx_offline_y0",
                            100,
                            -0.2,
                            0.2);
    m_vtx_offline_z0 = book(m_name,
                            "vtx_offline_z0",
                            "vtx_offline_z0",
                            100,
                            -200,
                            200);
    m_vtx_offline_z0_s = book(m_name,
                              "vtx_offline_z0_s",
                              "vtx_offline_z0_s",
                              100,
                              -10,
    ...
    m_vtx_online_x0 = book(m_name,
                           "vtx_online_x0",
                           "vtx_online_x0",
                           100,
                           -0.2,
                           0.2);
    m_vtx_online_y0 = book(m_name,
                           "vtx_online_y0",
                           "vtx_online_y0",
                           100,
                           -0.2,
                           0.2);
    m_vtx_online_z0 = book(m_name,
                           "vtx_online_z0",
                           "vtx_online_z0",
                           100,
                           -200,
                           200);
    m_vtx_online_z0_s = book(m_name,
                             "vtx_online_z0_s",
                             "vtx_online_z0_s",
                             100,
                             -10,
    ...
    m_vtx_online_x0_raw = book(m_name,
                               "vtx_online_x0_raw",
                               "vtx_online_x0_raw",
                               100,
                               -0.2,
                               0.2);
    m_vtx_online_y0_raw = book(m_name,
                               "vtx_online_y0_raw",
                               "vtx_online_y0_raw",
                               100,
                               -0.2,
                               0.2);
    m_vtx_online_z0_raw = book(m_name,
                               "vtx_online_z0_raw",
                               "vtx_online_z0_raw",
                               100,
                               -200,
    ...
    m_vtxOnlineValid = book(m_name,
                            "vtx_online_valid",
                            "vtx_online_valid",
                            2,
                            -0.5,
                            1.5);
    m_vtxOfflineValid = book(m_name,
                             "vtx_offline_valid",
                             "vtx_offline_valid",
                             2,
                             -0.5,
    ...
    m_vtxDiffx0 = book(m_name,
                       ...
                       0.1);
    m_vtxDiffx0_l =
      book(m_name, "vtx_diff_x0_l", "vtx_diff_x0_l", 100, -1, 1);

    m_vtxDiffy0 = book(m_name,
                       "vtx_diff_y0",
                       "vtx_diff_y0",
                       100,
                       -0.1,
                       0.1);
    m_vtxDiffy0_l =
      book(m_name, "vtx_diff_y0_l", "vtx_diff_y0_l", 100, -1,   1);

    m_vtxDiffz0 =
      book(m_name, "vtx_diff_z0",   "vtx_diff_z0",   100, -100, 100);
    m_vtxDiffz0_m =
      book(m_name, "vtx_diff_z0_m", "vtx_diff_z0_m", 100, -20,  20);
    ...
    m_vtxDiffz0_s_vs_vtx_offline_z0 = book(m_name,
                                           "vtxDiffz0_s_vs_vtx_offline_z0",
                                           "vtx_offline_z0",
                                           100,
                                           -200,
                                           200,
    ...
    m_vtx_online_y0_vs_vtx_online_z0 = book(m_name,
                                            "vtx_online_y0_vs_vtx_online_z0",
                                            "vtx_online_z0",
                                            100,
                                            -50,
                                            50,
    ...
    m_vtx_online_x0_vs_vtx_online_z0 = book(m_name,
                                            "vtx_online_x0_vs_vtx_online_z0",
                                            "vtx_online_z0",
                                            100,
                                            -50,
                                            50,
    ...
    if (m_infoSwitch->m_vsLumiBlock) {
      m_vtxDiffx0_vs_lBlock = book(m_name,
                                   "vtxDiffx0_vs_lBlock",
                                   "LumiBlock",
                                   200,
                                   0,
                                   ...
                                   -0.1,
                                   0.1);
      m_vtxDiffy0_vs_lBlock = book(m_name,
                                   "vtxDiffy0_vs_lBlock",
                                   "LumiBlock",
                                   200,
                                   0,
                                   ...
                                   -0.1,
                                   0.1);
      m_vtxDiffz0_vs_lBlock = book(m_name,
                                   "vtxDiffz0_vs_lBlock",
                                   "LumiBlock",
                                   200,
                                   0,
                                   ...
                                   -5,
                                   5);
      m_vtxClass_vs_lBlock = book(m_name,
                                  "vtxClass_vs_lBlock",
                                  "LumiBlock",
                                  200,
                                  0,
                                  ...
                                  -0.1,
                                  1.1);
      m_vtxEff1_vs_lBlock = book(m_name,
                                 "vtxEff1_vs_lBlock",
                                 "LumiBlock",
                                 200,
                                 0,
                                 ...
                                 -0.1,
                                 1.1);
      m_vtxEff10_vs_lBlock = book(m_name,
                                  "vtxEff10_vs_lBlock",
                                  "LumiBlock",
                                  200,
                                  0,
                                  ...
                                  -0.1,
                                  1.1);
      m_vtxEff1_raw_vs_lBlock = book(m_name,
                                     "vtxEff1_raw_vs_lBlock",
                                     "LumiBlock",
                                     200,
                                     0,
                                     2000,
                                     ...
                                     -0.1,
                                     1.1);
      m_vtxEff10_raw_vs_lBlock = book(m_name,
                                      "vtxEff10_raw_vs_lBlock",
                                      "LumiBlock",
                                      200,
                                      0,
                                      2000,
                                      ...
                                      -0.1,
                                      1.1);
      m_vtxEff1_noDummy_vs_lBlock = book(m_name,
                                         "vtxEff1_noDummy_vs_lBlock",
                                         "LumiBlock",
                                         200,
                                         0,
                                         2000,
                                         ...
                                         -0.1,
                                         1.1);
      m_vtxEff10_noDummy_vs_lBlock = book(m_name,
                                          "vtxEff10_noDummy_vs_lBlock",
                                          "LumiBlock",
                                          200,
                                          0,
                                          2000,
    ...
    if (m_infoSwitch->m_lumiB_runN) {
      ...
      { 297730, 298595, 298609, 298633, 298687, 298690, 298771, 298773, 298862,
        ...
        311287, 311321, 311365, 311402, 311473, 311481, 311500 };
      int nRunBins = 150;

      m_lumiB_runN = book(m_name,
                          "lumiB_runN",
                          "Lumi Block",
                          2000,
                          0,
                          ...
                          nRunBins,
                          runBins);
      m_lumiB_runN_bs_online_vz = book(m_name,
                                       "lumiB_runN_bs_online_vz",
                                       "Lumi Block",
                                       2000,
                                       0,
                                       2000,
                                       ...
                                       nRunBins,
                                       runBins);
      m_lumiB_runN_bs_den = book(m_name,
                                 "lumiB_runN_bs_den",
                                 "Lumi Block",
                                 2000,
                                 0,
                                 ...
                                 nRunBins,
                                 runBins);
      m_lumiB_runN_vtxClass = book(m_name,
                                   "lumiB_runN_vtxClass",
                                   "Lumi Block",
                                   2000,
                                   0,
      ...
      // m_lumiB_runN_vtxDiffz0    = book(m_name, "lumiB_runN_vtxDiffz0",
      //    "Lumi Block", 2000, 0, 2000, "Run Number", nRunBins, runBins);
      m_lumiB_runN_lumiB = book(m_name,
                                "lumiB_runN_lumiB",
                                "Lumi Block",
                                2000,
                                0,
  ...
  {
    // m_NumTrkPt1000PV     = book(m_name, "NumTrkPt1000PV",   m_titlePrefix+"
    // jet N_{trk,P_{T}>1 GeV}"     ,  50, -0.5, 49.5);
    // m_SumPtTrkPt1000PV   = book(m_name, "SumPtTrkPt1000PV", m_titlePrefix+"
    // jet #sum_{trk,P_{T}>1 GeV}"  , 100,    0, 1000);
    // m_TrackWidthPt1000PV = book(m_name, "TrackWidthPt1000P",m_titlePrefix+"
    // jet w_{trk,P_{T}>1 GeV}"     , 100,    0, 0.5);
    // m_NumTrkPt500PV      = book(m_name, "NumTrkPt500PV",    m_titlePrefix+"
    // jet N_{trk,P_{T}>500 MeV}"   ,  50, -0.5, 49.5);
    // m_SumPtTrkPt500PV    = book(m_name, "SumPtTrkPt500PV",  m_titlePrefix+"
    // jet #sum_{trk,P_{T}>500 MeV}", 100,    0, 1000);
    // m_TrackWidthPt500PV  = book(m_name, "TrackWidthPt500P", m_titlePrefix+"
    // jet w_{trk,P_{T}>500 MeV}"   , 100,    0, 0.5);
    // m_JVFPV              = book(m_name, "JVFPV",            m_titlePrefix+"
    // jet JVF_{PV}"                , 100,    0, 0.5);
  }

  // trackAll or trackPV
  if (m_infoSwitch->m_trackAll || m_infoSwitch->m_trackPV)
  {
    // m_Jvt       = book(m_name, "Jvt",        m_titlePrefix+" jet JVT"       ,
    // 100, -0.2, 1);
    // m_JvtJvfcorr= book(m_name, "JvtJvfcorr", m_titlePrefix+" jet corrJVF"   ,
    // 100, -1  , 1);
    // m_JvtRpt    = book(m_name, "JvtRpt",     m_titlePrefix+" jet R_{p_{T}}" ,
    // 100,  0  , 1.5);
  }
  ...
  if (m_infoSwitch->m_byAverageMu) {
    ...
    m_jetPt_avgMu_00_15 = book(m_name,
                               "jetPt_avgMu_00_15",
                               "jet p_{T} [GeV]",
                               120,
                               0,
                               600);
    m_jetPt_avgMu_15_25 = book(m_name,
                               "jetPt_avgMu_15_25",
                               "jet p_{T} [GeV]",
                               120,
                               0,
                               600);
    m_jetPt_avgMu_25 = book(m_name,
                            "jetPt_avgMu_25",
                            "jet p_{T} [GeV]",
                            120,
                            0,
...
StatusCode JetHists::execute(const xAOD::Jet       *jet,
                             float                  eventWeight,
...
StatusCode JetHists::execute(const xAOD::IParticle *particle,
                             float                  eventWeight,
                             const xAOD::EventInfo *eventInfo) {
  RETURN_CHECK("IParticleHists::execute()",
               IParticleHists::execute(particle, eventWeight, eventInfo), "");
  ...
  if (jet == 0)
  {
    ::Error("JetHists::execute()",
            XAOD_MESSAGE("Cannot convert IParticle to Jet"));
  ...
  if (m_infoSwitch->m_energy) {
    ...
    /*
       ...
       static SG::AuxElement::ConstAccessor<float> ePerSamp
          ("EnergyPerSampling");
       if( ePerSamp.isAvailable( *jet ) ) {
       m_ePerSamp ->  Fill( ePerSamp( *jet ), eventWeight );
       }

       static SG::AuxElement::ConstAccessor<float> fracSampMax
          ("FracSamplingMax");
       if( fracSampMax.isAvailable( *jet ) ) {
       m_fracSampMax ->  Fill( fracSampMax( *jet ), eventWeight );
       }

       static SG::AuxElement::ConstAccessor<float> lowEtFrac
  ...
  if (m_infoSwitch->m_layer) {
    ...
    static SG::AuxElement::ConstAccessor<vector<float> > ePerSamp(
      "EnergyPerSampling");
  ...
  if (m_infoSwitch->m_truth) {
    ...
    if (TruthLabelID.isAvailable(*jet)) {
      ...
      static SG::AuxElement::ConstAccessor<int> PartonTruthLabelID(
        "PartonTruthLabelID");
    ...
    static SG::AuxElement::ConstAccessor<int> HadronConeExclTruthLabelID(
      "HadronConeExclTruthLabelID");

    if (HadronConeExclTruthLabelID.isAvailable(*jet)) {
      m_hadronConeExclTruthLabelID->Fill(HadronConeExclTruthLabelID(
                                           *jet), eventWeight);
    }
    ...
    static SG::AuxElement::ConstAccessor<float> TruthLabelDeltaR_B(
      "TruthLabelDeltaR_B");
    ...
    static SG::AuxElement::ConstAccessor<float> TruthLabelDeltaR_C(
      "TruthLabelDeltaR_C");
    ...
    static SG::AuxElement::ConstAccessor<float> TruthLabelDeltaR_T(
      "TruthLabelDeltaR_T");
  ...
  if (m_infoSwitch->m_truthDetails) {
    ...
    // B-Hadron Details
    //
    static SG::AuxElement::ConstAccessor<int> GhostBHadronsFinalCount(
      "GhostBHadronsFinalCount");
    ...
    static SG::AuxElement::ConstAccessor<int> GhostBHadronsInitialCount(
      "GhostBHadronsInitialCount");
    ...
    static SG::AuxElement::ConstAccessor<int> GhostBQuarksFinalCount(
      "GhostBQuarksFinalCount");
    ...
    static SG::AuxElement::ConstAccessor<float> GhostBHadronsFinalPt(
      "GhostBHadronsFinalPt");
    ...
    static SG::AuxElement::ConstAccessor<float> GhostBHadronsInitialPt(
      "GhostBHadronsInitialPt");
    ...
    static SG::AuxElement::ConstAccessor<float> GhostBQuarksFinalPt(
      "GhostBQuarksFinalPt");
    ...
    // C-Hadron Details
    //
    static SG::AuxElement::ConstAccessor<int> GhostCHadronsFinalCount(
      "GhostCHadronsFinalCount");
    ...
    static SG::AuxElement::ConstAccessor<int> GhostCHadronsInitialCount(
      "GhostCHadronsInitialCount");
    ...
    static SG::AuxElement::ConstAccessor<int> GhostCQuarksFinalCount(
      "GhostCQuarksFinalCount");
    ...
    static SG::AuxElement::ConstAccessor<float> GhostCHadronsFinalPt(
      "GhostCHadronsFinalPt");
    ...
    static SG::AuxElement::ConstAccessor<float> GhostCHadronsInitialPt(
      "GhostCHadronsInitialPt");
    ...
    static SG::AuxElement::ConstAccessor<float> GhostCQuarksFinalPt(
      "GhostCQuarksFinalPt");
    ...
    // Tau Details
    //
    static SG::AuxElement::ConstAccessor<int> GhostTausFinalCount(
      "GhostTausFinalCount");
    ...
    static SG::AuxElement::ConstAccessor<float> GhostTausFinalPt(
      "GhostTausFinalPt");
  ...
  if (m_infoSwitch->m_flavTag || m_infoSwitch->m_flavTagHLT) {
    ...
    static SG::AuxElement::ConstAccessor<double> SV0_significance3DAcc(
      "SV0_significance3D");

    if (SV0_significance3DAcc.isAvailable(*btag_info)) {
      m_COMB->Fill(
        btag_info->SV1_loglikelihoodratio() + btag_info->IP3D_loglikelihoodratio(),
        eventWeight);
      m_JetFitter->Fill(btag_info->JetFitter_loglikelihoodratio(), eventWeight);
      m_JetFitterCombNN->Fill(
        btag_info->JetFitterCombNN_loglikelihoodratio(), eventWeight);
    }

    if (m_infoSwitch->m_btag_jettrk) {
      if (m_debug) std::cout << "JetHists: m_btag_jettrk " << std::endl;
      unsigned trkSum_ntrk =
        btag_info->isAvailable<unsigned>("trkSum_ntrk") ? btag_info->auxdata<
          unsigned>("trkSum_ntrk") : -1;
      float trkSum_sPt =
        btag_info->isAvailable<float>("trkSum_SPt") ? btag_info->auxdata<float>(
          "trkSum_SPt") : -1000; // <== -1 GeV
      float trkSum_vPt     = 0;
      float trkSum_vAbsEta = -10;

      if (trkSum_ntrk > 0) {
        trkSum_vPt =
          btag_info->isAvailable<float>("trkSum_VPt") ?      btag_info->auxdata<
            float>("trkSum_VPt")  : -1000;
        trkSum_vAbsEta =
          btag_info->isAvailable<float>("trkSum_VEta") ? fabs(btag_info->auxdata<
                                                                float>(
                                                                "trkSum_VEta")) :
          -10;
      }
      ...
      bool trksOK =
        btag_info->variable<std::vector<ElementLink<xAOD::TrackParticleContainer> > >(
          "IP3D",
          "TrackParticleLinks",
          associationLinks);
      ...
      trksOK &= btag_info->variable<std::vector<float> >("IP3D",
                                                         "valD0wrtPVofTracks",
                                                         vectD0);
      trksOK &= btag_info->variable<std::vector<float> >("IP3D",
                                                         "sigD0wrtPVofTracks",
      ...
      if (vectD0.size() and vectD0Signi.size() and vectZ0.size() and vectZ0Signi.
          size()) {
      ...
      if (trksOK) {
        ...
        for (auto trkIter = associationLinks.begin();
             trkIter != associationLinks.end(); ++trkIter) {
        ...
        float sv_scaled_efc = sv1_ntkv >
                              0               ? sv1_efrc *
                              (static_cast<float>(ntrks) / sv1_ntkv)  : -1;

        int jf_ntrkv;  btag_info->variable<int>("JetFitter",
                                                "nTracksAtVtx",
                                                jf_ntrkv);
        int jf_nvtx1t; btag_info->variable<int>("JetFitter",
                                                "nSingleTracks",
                                                jf_nvtx1t);
        float jf_efrc; btag_info->variable<float>("JetFitter",
                                                  "energyFraction",
                                                  jf_efrc);
        float jf_scaled_efc = (jf_ntrkv + jf_nvtx1t) >
                              0 ? jf_efrc *
                              (static_cast<float>(ntrks) /
                               (jf_ntrkv + jf_nvtx1t)) : -1;
    ...
    if (m_infoSwitch->m_jetFitterDetails) {
      ...
      static SG::AuxElement::ConstAccessor<int> jf_nSingleTracks(
        "JetFitter_nSingleTracks");
      static SG::AuxElement::ConstAccessor<int> jf_nTracksAtVtx(
        "JetFitter_nTracksAtVtx");
      static SG::AuxElement::ConstAccessor<float> jf_mass("JetFitter_mass");
      static SG::AuxElement::ConstAccessor<float> jf_energyFraction(
        "JetFitter_energyFraction");
      static SG::AuxElement::ConstAccessor<float> jf_significance3d(
        "JetFitter_significance3d");
      static SG::AuxElement::ConstAccessor<float> jf_deltaeta(
        "JetFitter_deltaeta");
      static SG::AuxElement::ConstAccessor<float> jf_deltaphi(
        "JetFitter_deltaphi");
      ...
      if (jf_nVTXAcc.isAvailable(*btag_info)) m_jf_nVTX->Fill(jf_nVTXAcc(*
                                                                         btag_info),
                                                              eventWeight);

      if (jf_nSingleTracks.isAvailable(*btag_info)) m_jf_nSingleTracks->Fill(jf_nSingleTracks(
                                                                               *
                                                                               btag_info),
                                                                             eventWeight);
      ...
      if (jf_nTracksAtVtx.isAvailable(*btag_info)) m_jf_nTracksAtVtx->Fill(jf_nTracksAtVtx(
                                                                             *
                                                                             btag_info),
                                                                           eventWeight);
      ...
      if (jf_mass.isAvailable(*btag_info)) m_jf_mass->Fill(jf_mass(
                                                             *btag_info) / 1000,
                                                           eventWeight);

      if (jf_energyFraction.isAvailable(*btag_info)) m_jf_energyFraction->Fill(jf_energyFraction(
                                                                                 *
                                                                                 btag_info),
                                                                               eventWeight);


      if (jf_significance3d.isAvailable(*btag_info)) m_jf_significance3d->Fill(jf_significance3d(
                                                                                 *
                                                                                 btag_info),
                                                                               eventWeight);
      ...
      if (jf_deltaphi.isAvailable(*btag_info)) {
        m_jf_deltaR->Fill(hypot(jf_deltaphi(*btag_info), jf_deltaeta(
                                  *btag_info)), eventWeight);
        m_jf_deltaphi->Fill(jf_deltaphi(*btag_info), eventWeight);
        m_jf_deltaphi_l->Fill(jf_deltaphi(*btag_info), eventWeight);
      }

      if (jf_N2Tpar.isAvailable(*btag_info)) m_jf_N2Tpar->Fill(jf_N2Tpar(*
                                                                         btag_info),
        eventWeight);

      if (jf_pb.isAvailable(*btag_info)) m_jf_pb->Fill(jf_pb(
          *btag_info), eventWeight);
  ...
  /*
     vector<float> chfs = jet->getAttribute< vector<float>
  ...
  if (m_infoSwitch->m_onlineBS) {
    ...
    if (fabs(bs_online_vz) < 1) m_eta_bs_online_vz_0_1->Fill(jet->eta(), eventWeight); else if (fabs(bs_online_vz) < 1.5) m_eta_bs_online_vz_1_1p5->Fill(jet->eta(), eventWeight); else if (fabs(bs_online_vz) < 2) m_eta_bs_online_vz_1p5_2->Fill(jet->eta(), eventWeight);
  ...
  if (m_infoSwitch->m_hltVtxComp || m_infoSwitch->m_onlineBS) {
    ...
    // Use of vtxClass is new, hadDummyPV is old but need backward
    // compatibility.
    ...
    if (m_infoSwitch->m_hltVtxComp) {
      ...
      if (offline_pvx && online_pvx) {
        ...
        if (m_infoSwitch->m_lumiB_runN) {
          ...
          // if(offline_pvx && online_pvx){
          //  float vtxDiffz0     = online_pvx->z() - offline_pvx->z();
          //  m_lumiB_runN_vtxDiffz0  -> Fill(lumiBlock, runNumber, eventWeight
          // * vtxDiffz0);
          // }
        }
      }
...
StatusCode JetHists::execute(const xAH::Particle *particle, float eventWeight, const xAH::EventInfo *eventInfo) {
  ...
  if (m_infoSwitch->m_clean)
  {
    ...
    // m_LArQmean                  ->Fill(jet->AverageLArQF/65535
    //        ,eventWeight);
    // m_LArBadHVEFrac             ->Fill(jet->LArBadHVEFrac
    //             ,eventWeight);
    // m_LArBadHVNCell             ->Fill(jet->LArBadHVNCell
    //             ,eventWeight);
    // m_OotFracClusters5          ->Fill(jet->OotFracClusters5
    //          ,eventWeight);
    // m_OotFracClusters10         ->Fill(jet->OotFracClusters10
    //         ,eventWeight);
    // m_LeadingClusterPt          ->Fill(jet->LeadingClusterPt
    //          ,eventWeight);
    ...
    // m_LeadingClusterSecondR     ->Fill(jet->LeadingClusterSecondR
    //     ,eventWeight);
    // m_clean_passLooseBad        ->Fill(jet->clean_passLooseBad
    //        ,eventWeight);
    // m_clean_passLooseBadUgly    ->Fill(jet->clean_passLooseBadUgly
    //    ,eventWeight);
    // m_clean_passTightBad        ->Fill(jet->clean_passTightBad
    //        ,eventWeight);
    // m_clean_passTightBadUgly    ->Fill(jet->clean_passTightBadUgly
    //    ,eventWeight);
  }
  ...
  if (m_infoSwitch->m_flavTag || m_infoSwitch->m_flavTagHLT)
  {
    ...
    // m_JetFitter               ->Fill(jet->JetFitter            ,
    // eventWeight);
    // m_JetFitterCombNN         ->Fill(jet->JetFitter            ,
    // eventWeight);
  ...
  if (m_infoSwitch->m_onlineBS) {
    ...
    if (fabs(bs_online_vz) < 1) m_eta_bs_online_vz_0_1->Fill(jet->p4.Eta(), eventWeight); else if (fabs(bs_online_vz) < 1.5) m_eta_bs_online_vz_1_1p5->Fill(jet->p4.Eta(), eventWeight); else if (fabs(bs_online_vz) < 2) m_eta_bs_online_vz_1p5_2->Fill(jet->p4.Eta(), eventWeight);
  ...
  if (m_infoSwitch->m_hltVtxComp ||  m_infoSwitch->m_onlineBS)
  {
    ...
    if (m_infoSwitch->m_hltVtxComp) {
      ...
      //   std::cout << " -> bs_online_vx" << bs_online_vx << "bs_online_vy" <<
      // bs_online_vy << "bs_online_vz" << bs_online_vz << std::endl;
      // }
      ...
      // m_vtx_offline_z                 ->Fill(jet->vtx_offline_z0          ,
      // eventWeight);
      // m_vtx_online_z                 ->Fill(jet->vtx_online_z0          ,
      // eventWeight);
  ...
  if (m_infoSwitch->m_truth)
  {
    ...
    // m_GhostTruthAssociationFraction->Fill(jet->GhostTruthAssociationFraction,
    // eventWeight);
