...
namespace HelperClasses {
  ...
  {
    std::string ElectronIDLoose("ElectronIDLoose");           enumMap.insert(std::make_pair(
                                                                               ElectronIDLoose,
                                                                               egammaPID
                                                                               ::
                                                                               ElectronIDLoose));
    std::string ElectronIDMedium("ElectronIDMedum");          enumMap.insert(std::make_pair(
                                                                               ElectronIDMedium,
                                                                               egammaPID
                                                                               ::
                                                                               ElectronIDMedium));
    std::string ElectronIDTight("ElectronIDTight");           enumMap.insert(std::make_pair(
                                                                               ElectronIDTight,
                                                                               egammaPID
                                                                               ::
                                                                               ElectronIDTight));
    std::string ElectronIDLoosePP("ElectronIDLoosePP");       enumMap.insert(std::make_pair(
                                                                               ElectronIDLoosePP,
                                                                               egammaPID
                                                                               ::
                                                                               ElectronIDLoosePP));
    std::string ElectronIDLoose1("ElectronIDLoose1");         enumMap.insert(std::make_pair(
                                                                               ElectronIDLoose1,
                                                                               egammaPID
                                                                               ::
                                                                               ElectronIDLoose1));
    std::string ElectronIDLooseHLT("ElectronIDLooseHLT");     enumMap.insert(std::make_pair(
                                                                               ElectronIDLooseHLT,
                                                                               egammaPID
                                                                               ::
                                                                               ElectronIDLooseHLT));
    std::string ElectronIDMediumPP("ElectronIDMediumPP");     enumMap.insert(std::make_pair(
                                                                               ElectronIDMediumPP,
                                                                               egammaPID
                                                                               ::
                                                                               ElectronIDMediumPP));
    std::string ElectronIDMedium1("ElectronIDMedium1");       enumMap.insert(std::make_pair(
                                                                               ElectronIDMedium1,
                                                                               egammaPID
                                                                               ::
                                                                               ElectronIDMedium1));
    std::string ElectronIDMediumHLT("ElectronIDMediumHLT");   enumMap.insert(std::make_pair(
                                                                               ElectronIDMediumHLT,
                                                                               egammaPID
                                                                               ::
                                                                               ElectronIDMediumHLT));
    std::string ElectronIDTightPP("ElectronIDTightPP");       enumMap.insert(std::make_pair(
                                                                               ElectronIDTightPP,
                                                                               egammaPID
                                                                               ::
                                                                               ElectronIDTightPP));
    std::string ElectronIDTight1("ElectronIDTight1");         enumMap.insert(std::make_pair(
                                                                               ElectronIDTight1,
                                                                               egammaPID
                                                                               ::
                                                                               ElectronIDTight1));
    std::string ElectronIDTightHLT("ElectronIDTightHLT");     enumMap.insert(std::make_pair(
                                                                               ElectronIDTightHLT,
                                                                               egammaPID
                                                                               ::
                                                                               ElectronIDTightHLT));
  ...
  //  {
  //    std::string IsEMLoose("IsEMLoose");     enumMap.insert(std::make_pair(
  // IsEMLoose , egammaPID::IsEMLoose));
  //    std::string IsEMMedium("IsEMMedium");   enumMap.insert(std::make_pair(
  // IsEMMedium, egammaPID::IsEMMedium));
  //    std::string IsEMTight("IsEMTight");     enumMap.insert(std::make_pair(
  // IsEMTight , egammaPID::IsEMTight));
  //  }
  ...
  EnumParser<xAOD::Muon::MuonType>::EnumParser()
  {
    ...
    enumMap.insert(std::make_pair(SiliconAssociatedForwardMuon,
  ...
  void IParticleInfoSwitch::initialize() {
    ...
    for (auto configDetail : m_configDetails)
    {
      ...
      {
        m_numLeading =
          std::atoi(configDetail.substr(8, std::string::npos).c_str());
        break;
      }
    }
  ...
  void MuonInfoSwitch::initialize() {
    ...
    while (std::getline(ss, token, ' ')) {
      if (token.compare(0, reco_prfx.length(),
                        reco_prfx) == 0) m_recoWPs.push_back(token);

      if (token.compare(0, isol_prfx.length(),
                        isol_prfx) == 0) m_isolWPs.push_back(token);

      if (token.compare(0, trig_prfx.length(),
                        trig_prfx) == 0) m_trigWPs.push_back(token);
    }
  ...
  void ElectronInfoSwitch::initialize() {
    ...
    while (std::getline(ss, token, ' ')) {
      ...
      if (token.find("isolNoRequirement") !=
          std::string::npos) m_isolWPs.push_back("");
      ...
      if ((token.find(trig_keyword1) != std::string::npos) ||
          ...
          (token.find(trig_keyword4) != std::string::npos)) m_trigWPs.push_back(
          token);
    }
  }
  ...
  void METInfoSwitch::initialize() {
    ...
    m_refJetTrk = has_exact("refJetTrk"); // take this one *only* if requested
                                          // by user explicitly
