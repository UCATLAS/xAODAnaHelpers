...
StatusCode ElectronHists::execute(const xAOD::IParticle* particle, float eventWeight, const xAOD::EventInfo* eventInfo) {
    ...
    if(m_infoSwitch->m_isolation) {
        ...
        if( isIsoLooseTrackOnlyAcc.isAvailable(*electron) ) m_isIsolated_LooseTrackOnly->Fill(isIsoLooseTrackOnlyAcc(*electron), eventWeight); else m_isIsolated_LooseTrackOnly->Fill(-1, eventWeight); if( isIsoLooseAcc.isAvailable(*electron) ) m_isIsolated_Loose->Fill(isIsoLooseAcc(*electron), eventWeight); else m_isIsolated_Loose->Fill(-1, eventWeight); if( isIsoTightAcc.isAvailable(*electron) ) m_isIsolated_Tight->Fill(isIsoTightAcc(*electron), eventWeight); else m_isIsolated_Tight->Fill(-1, eventWeight); if( isIsoGradientAcc.isAvailable(*electron) ) m_isIsolated_Gradient->Fill(isIsoGradientAcc(*electron), eventWeight); else m_isIsolated_Gradient->Fill(-1, eventWeight); if( isIsoGradientLooseAcc.isAvailable(*electron) ) m_isIsolated_GradientLoose->Fill(isIsoGradientLooseAcc(*electron), eventWeight); else m_isIsolated_GradientLoose->Fill(-1, eventWeight); if( isIsoFixedCutLooseAcc.isAvailable(*electron) ) m_isIsolated_FixedCutLoose->Fill(isIsoFixedCutLooseAcc(*electron), eventWeight); else m_isIsolated_FixedCutLoose->Fill(-1, eventWeight); if( isIsoFixedCutTightAcc.isAvailable(*electron) ) m_isIsolated_FixedCutTight->Fill(isIsoFixedCutTightAcc(*electron), eventWeight); else m_isIsolated_FixedCutTight->Fill(-1, eventWeight); if( isIsoFixedCutTightTrackOnlyAcc.isAvailable(*electron) ) m_isIsolated_FixedCutTightTrackOnly->Fill(isIsoFixedCutTightTrackOnlyAcc(*electron), eventWeight); else m_isIsolated_FixedCutTightTrackOnly->Fill(-1, eventWeight); if( isIsoUserDefinedFixEfficiencyAcc.isAvailable(*electron) ) m_isIsolated_UserDefinedFixEfficiency->Fill(isIsoUserDefinedFixEfficiencyAcc(*electron), eventWeight); else m_isIsolated_UserDefinedFixEfficiency->Fill(-1, eventWeight); if( isIsoUserDefinedCutAcc.isAvailable(*electron) ) m_isIsolated_UserDefinedCut->Fill(isIsoUserDefinedCutAcc(*electron), eventWeight); else m_isIsolated_UserDefinedCut->Fill(-1, eventWeight);
