...
EL::StatusCode ElectronSelector::initialize() {
    ...
    //
    if(m_debug) Info( "initialize()", "Adding isolation WP %s to IsolationSelectionTool", ( m_IsoKeys.at(0) ).c_str() ); RETURN_CHECK("ElectronSelector::initialize()", m_isolationSelectionTool_handle.setProperty( "ElectronWP", ( m_IsoKeys.at(0) ).c_str() ), "Failed to configure base WP");
...
bool ElectronSelector::executeSelection(const xAOD::ElectronContainer* inElectrons, float mcEvtWeight, bool countPass,
  ConstDataVector<xAOD::ElectronContainer>* selectedElectrons) {
    ...
    return true;
} // ElectronSelector::executeSelection
