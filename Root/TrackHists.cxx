...
StatusCode TrackHists::initialize() {
  ...
  m_trk_Phi  = book(m_name, "phi",         "trk #phi", 120,
                    -TMath::Pi(), TMath::Pi());
  ...
  m_trk_z0sinT =
    book(m_name, "z0sinT", "z0xsin(#theta)[mm]", 100, -5.0, 5.0);
  ...
  if (m_detailStr.find("2D") != std::string::npos) {
    ...
    m_trk_Eta_vs_trk_P = book(m_name,
                              "trk_Eta_vs_trk_P",
                              "trk |p| [GeV]",
                              100,
                              0,
                              ...
                              -4,
                              4);
    m_trk_Eta_vs_trk_P_l = book(m_name,
                                "trk_Eta_vs_trk_P_l",
                                "trk |p| [GeV]",
                                100,
                                0,
                                ...
                                -4,
                                4);
    m_trk_Phi_vs_trk_P = book(m_name,
                              "trk_Phi_vs_trk_P",
                              "trk |p| [GeV]",
                              100,
                              0,
                              ...
                              -TMath::Pi(),
                              TMath::  Pi());
    m_trk_Phi_vs_trk_P_l = book(m_name,
                                "trk_Phi_vs_trk_P_l",
                                "trk |p| [GeV]",
                                100,
                                0,
                                ...
                                -TMath::Pi(),
                                TMath::Pi());
    m_trk_Eta_vs_trk_Phi = book(m_name,
                                "trk_Eta_vs_trk_Phi",
                                "trk #phi",
                                120,
                                -TMath::Pi(),
    ...
    m_trk_d0_vs_trk_P = book(m_name,
                             ...
                             -5.0,
                             5.0);
    m_trk_d0_vs_trk_P_l = book(m_name,
                               "trk_d0_vs_trk_P_l",
                               "trk |p| [GeV]",
                               100,
                               0,
    ...
    m_trk_z0_vs_trk_P = book(m_name,
                             ...
                             -5.0,
                             5.0);
    m_trk_z0_vs_trk_P_l = book(m_name,
                               "trk_z0_vs_trk_P_l",
                               "trk |p| [GeV]",
                               100,
                               0,
                               ...
                               -5.0,
                               5.0);
    m_trk_z0sinT_vs_trk_P = book(m_name,
                                 "trk_z0sinT_vs_trk_P",
                                 "trk |p| [GeV]",
                                 100,
                                 0,
                                 ...
                                 -5.0,
                                 5.0);
    m_trk_z0sinT_vs_trk_P_l = book(m_name,
                                   "trk_z0sinT_vs_trk_P_l",
                                   "trk |p| [GeV]",
                                   100,
                                   0,
                                   100,
  ...
  if (m_detailStr.find("IPDetails") != std::string::npos) {
    ...
    m_trk_d0Err = book(m_name,
                       "d0Err",
                       "d0Err[mm]",
                       100,
                       0,
                       0.4);
    m_trk_d0_l = book(m_name,
                      "d0_l",
                      "d0[mm]",
                      100,
                      -10.0,
                      10.0);
    m_trk_d0_ss = book(m_name,
                       "d0_ss",
                       "d0[mm]",
                       100,
                       -0.2,
    ...
    m_trk_z0_l = book(m_name,
                      "z0_l",
                      "z0[mm]",
                      100,
                      -600.0,
                      600.0);
    m_trk_z0sinT_l = book(m_name,
                          "z0sinT_l",
                          "z0xsin(#theta)[mm]",
                          100,
                          -20.0,
                          20.0);
    m_trk_z0Err = book(m_name,
                       "z0Err",
                       "z0Err[mm]",
                       100,
                       0,
                       0.4);
    m_trk_z0Sig = book(m_name,
                       "z0Sig",
                       "z0Sig",
                       100,
                       -25.0,
                       25.0);
    m_trk_z0SigsinT = book(m_name,
                           "z0SigsinT",
                           "z0 significance x sin(#theta)",
                           100,
                           -25.0,
                           25.0);

    // m_trk_mc_prob      = book(m_name, "mc_prob",      "mc_prob",     100,
    //  -0.1, 1.1 );
    // m_trk_mc_barcode   = book(m_name, "mc_barcode",   "mc_barcode",  100,
    //  -0.1, 0.5e6 );
    // m_trk_mc_barcode_s = book(m_name, "mc_barcode_s", "mc_barcode",  100,
    //  -0.1, 25e3 );
  }
  ...
  if (m_detailStr.find("HitCounts") != std::string::npos) {
    ...
    m_trk_nSi       =
      book(m_name, "nSi",        "nSi",        30, -0.5, 29.5);
    m_trk_nSiAndDead =
      book(m_name, "nSiAndDead", "nSi(+Dead)", 30, -0.5, 29.5);
    m_trk_nSiDead =
      book(m_name, "nSiDead",    "nSiDead",    10, -0.5, 9.5);
    m_trk_nSCT =
      book(m_name, "nSCT",       "nSCTHits",   20, -0.5, 19.5);
    m_trk_nPix =
      book(m_name, "nPix",       "nPix",       10, -0.5, 9.5);
    m_trk_nPixHoles =
      book(m_name, "nPixHoles",  "nPixHoles",  10, -0.5, 9.5);
    m_trk_nBL =
      book(m_name, "nBL",        "nBL",        3,  -0.5, 2.5);
    m_trk_nTRT =
      book(m_name, "nTRT",       "nTRT",       50, -0.5, 49.5);

    // m_trk_nTRTHoles  = book(m_name, "nTRTHoles",  "nTRTHoles",   50,   -0.5,
    // 49.5 );
    // m_trk_nTRTDead   = book(m_name, "nTRTDead",   "nTRTDead",    50,   -0.5,
    // 49.5 );
  }
  ...
  if (m_detailStr.find("TPErrors") != std::string::npos) {
    ...
    // m_chi2ndof TProfile(m_name, "chi2ndofvseta",  "chi2ndofvseta;    eta;
    //       chi2",  20,  -0.1, 2.7, 0, 4, "s" );
    // new TProfile(m_name, "chi2ndofvseta",  "chi2ndofvseta;    eta;
    //       chi2",  20,  -0.1, 2.7, 0, 4, "s" );
    // new TProfile(m_name, "nhitsvseta",  "nhitsvseta;    eta;       nhits",
    //  20,  -0.1, 2.7, 0, 15 , "s" );
    // new TProfile(m_name, "chi2ndofvspt",  "chi2ndofvseta;    pt;       chi2",
    //  50,  -0.1, 20, 0 , 4, "s" );

    //  new TProfile(m_name, "d0Errvseta",      "d0Errvseta;    eta;
    //       d0Err",  20,  -0.1, 2.7, 0, 0.4, "s" );
    //  new TProfile(m_name, "d0ErrvsIpt",      "d0ErrvsIpt;    Ipt;
    //       d0Err",  20,  -6e-4, 6e4, 0, 0.4, "s" );
    //  new TProfile(m_name, "d0Errvsphi",      "d0Errvsphi;    phi;
    //       d0Err",  1000,  -3.2, 3.2, 0, 0.4);
    //

    //  new TH2F(m_name, "z0d0"    ,    "z0d0;     z0[mm];  d0[mm];",  50,
    //  -300.0, 300.0, 50, -4.0, 4.0  );
    //  new TH2F(m_name, "z0sinTd0",    "z0sinTd0;     z0xsin0[mm](signed);
    //  d0[mm](signed);",  50,-2.0, 2.0, 50, -2.0, 2.0  );

    //  new TH2F(m_name, "d0vsPt"    ,    "d0vsPt;     d0[mm] (signed);
    //  Pt[GeV];",  100,  -2,2.0, 50, 0, 10  );
    //  new TH2F(m_name, "d0SigvsPt"    ,    "d0SigvsPt;     d0Sig(signed);
    //  Pt[GeV];",  240, -20, 40.0, 50, 0, 10  );
  ...
  if (m_detailStr.find("Chi2Details") != std::string::npos) {
    ...
    m_trk_chi2Prob_l  = book(m_name,
                             "chi2Prob_l",
                             "chi2Prob",
                             100,
                             -0.1,
                             1.1);
    m_trk_chi2Prob_s = book(m_name,
                            "chi2Prob_s",
                            "chi2Prob",
                            100,
                            -0.01,
                            0.1);
    m_trk_chi2Prob_ss = book(m_name,
                             "chi2Prob_ss",
                             "chi2Prob",
                             100,
                             -0.001,
                             0.01);
    m_trk_chi2ndof = book(m_name,
                          "chi2ndof",
                          "chi2ndof",
                          100,
                          0.0,
                          8.0);
    m_trk_chi2ndof_l = book(m_name,
                            "chi2ndof_l",
                            "chi2ndof",
                            100,
                            0.0,
  ...
  if (m_detailStr.find("Debugging") != std::string::npos) {
    ...
    m_trk_eta_vl    =
      book(m_name, "eta_vl", "eta", 100, -6, 6);
    m_trk_z0_vl = book(m_name,
                       "z0_vl",
                       "z0[mm]",
                       100,
                       -10000.0,
                       10000.0);
    m_trk_z0_raw_m = book(m_name,
                          "z0_raw_m",
                          "z0[mm]",
                          100,
                          -100.0,
                          100.0);
    m_trk_z0_atlas_m = book(m_name,
                            "z0_atlas_m",
                            "z0[mm]",
                            100,
                            -100.0,
                            100.0);
    m_trk_vz = book(m_name,
                    "vz",
                    "z0[mm]",
                    100,
                    -100.0,
                    100.0);
    m_trk_z0_m = book(m_name,
                      "z0_m",
                      "z0[mm]",
                      100,
                      -100.0,
                      100.0);
    m_trk_d0_vl = book(m_name,
                       "d0_vl",
                       "d0[mm]",
                       100,
                       -10000.0,
                       10000.0);
    m_trk_pt_ss = book(m_name,
                       "pt_ss",
                       "Pt[GeV",
                       100,
                       0,
                       2.0);
    m_trk_phiManyBins =
      book(m_name, "phiManyBins", "phi", 1000, -3.2, 3.2);
  }
  ...
  if (m_detailStr.find("vsLumiBlock") != std::string::npos) {
    ...
    m_lBlock = book(m_name,
                    "lBlock",
                    "LumiBlock",
                    100,
                    0,
                    1000);
    m_trk_z0_vs_lBlock = book(m_name,
                              "z0_vs_lBlock",
                              "LumiBlock",
                              100,
                              0,
                              ...
                              -100,
                              100);
    m_trk_z0_raw_vs_lBlock = book(m_name,
                                  "z0_raw_vs_lBlock",
                                  "LumiBlock",
                                  100,
                                  0,
                                  ...
                                  -100,
                                  100);
    m_trk_z0_atlas_vs_lBlock = book(m_name,
                                    "z0_atlas_vs_lBlock",
                                    "LumiBlock",
                                    100,
                                    0,
    ...
    m_trk_vz_vs_lBlock = book(m_name,
                              "vz_vs_lBlock",
                              "LumiBlock",
                              100,
                              0,
    ...
    m_pvz_vs_lBlock = book(m_name,
                           ...
                           -100,
                           100);
    m_pv_valid_vs_lBlock = book(m_name,
                                "pv_valid_vs_lBlock",
                                "LumiBlock",
                                100,
                                0,
    ...
    // m_trk_eta_vl      = book(m_name, "eta_vl",        "eta",       100,  -6,
    //    6     );
    // m_trk_z0_vl       = book(m_name, "z0_vl",         "z0[mm]",    100,
    //  -10000.0, 10000.0 );
    // m_trk_z0_m_raw    = book(m_name, "z0_m_raw",         "z0[mm]",   100,
    //  -100.0,  100.0 );
    // m_trk_z0_m        = book(m_name, "z0_m",         "z0[mm]",   100,
    //  -100.0,  100.0 );
    // m_trk_d0_vl       = book(m_name, "d0_vl",         "d0[mm]",    100,
    //  -10000.0, 10000.0 );
    // m_trk_pt_ss       = book(m_name, "pt_ss",         "Pt[GeV",    100,  0,
    //     2.0  );
    // m_trk_phiManyBins = book(m_name, "phiManyBins" ,  "phi",      1000,
    //  -3.2,  3.2   );
  }
...
StatusCode TrackHists::execute(const xAOD::TrackParticleContainer *trks,
  ...
  for (; trk_itr != trk_end; ++trk_itr) {
    RETURN_CHECK("TrackHists::execute()",
                 this->execute((*trk_itr), pvx, eventWeight, eventInfo), "");
  }
...
StatusCode TrackHists::execute(const xAOD::TrackParticle *trk,
                               const xAOD::Vertex        *pvx,
                               float                      eventWeight,
                               const xAOD::EventInfo     *eventInfo) {
  // basic
  ...
  if (m_fillHitCounts) {
    ...
    if (!trk->summaryValue(nBL,       xAOD::numberOfBLayerHits)) Error(
        "TrackHists::execute()",
        "BLayer hits not filled");

    if (!trk->summaryValue(nPix,      xAOD::numberOfPixelHits)) Error(
        "TrackHists::execute()",
        "Pix hits not filled");

    if (!trk->summaryValue(nPixDead,  xAOD::numberOfPixelDeadSensors)) Error(
        "TrackHists::execute()",
        "Pix Dead not filled");
    ...
    // if(!trk->summaryValue(nTRTHoles, xAOD::numberOfTRTHoles))
    //         Error("TrackHists::execute()", "TRT holes not filled");
    // if(!trk->summaryValue(nTRTDead,  xAOD::numberOfTRTDeadStraws))
    //    Error("TrackHists::execute()", "TRT Dead not filled");
  ...
  if (m_fillTPErrors) {
    // m_trk_phiErr       -> Fill(
    // sqrt((trk->definingParametersCovMatrixVec().at(6))) , eventWeight );
    // m_trk_thetaErr     -> Fill(
    // sqrt((trk->definingParametersCovMatrixVec().at(10))) , eventWeight );
    // m_trk_qOpErr       -> Fill(
    // sqrt((trk->definingParametersCovMatrixVec().at(15))) , eventWeight );
  }
