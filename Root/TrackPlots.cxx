...
EL::StatusCode TrackPlots :: histInitialize ()
{
  ...
  m_plots = new TrackPlotsClass(m_name,m_detailLevel);
...
EL::StatusCode TrackPlots :: fileExecute ()
{
...
EL::StatusCode TrackPlots :: changeInput (bool firstFile)
{
...
EL::StatusCode TrackPlots :: execute ()
{
  ...
  if ( !m_event->retrieve( trks, m_inContainerName.Data() ).isSuccess() ){
    if ( !m_store->retrieve( trks, m_inContainerName.Data() ).isSuccess() ){
      Error("TrackPlots::execute()  ", "Failed to retrieve %s container. Exiting.", m_inContainerName.Data() );
      return EL::StatusCode::FAILURE;
    }
  }
  ...
  // 1.
  m_plots->FillHistograms( trks, eventWeight );

  // 2.
//  xAOD::JetContainer::const_iterator jet_itr = trks->begin();
//  xAOD::JetContainer::const_iterator jet_end = trks->end();
...
EL::StatusCode TrackPlots :: postExecute ()
{
...
EL::StatusCode TrackPlots :: finalize ()
{
