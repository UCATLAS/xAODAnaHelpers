...
EL::StatusCode MetHistsAlgo::fileExecute() {
  return EL::StatusCode::SUCCESS;
}

EL::StatusCode MetHistsAlgo::changeInput(bool /*firstFile*/) {
  return EL::StatusCode::SUCCESS;
}
...
EL::StatusCode MetHistsAlgo::execute()
{
  ...
  RETURN_CHECK("MetHistsAlgo::execute()",
  ...
  RETURN_CHECK("MetHistsAlgo::execute()",
               HelperFunctions::retrieve(met,
                                         m_inContainerName,
                                         m_event,
                                         m_store,
                                         m_verbose),                     "");

  RETURN_CHECK("MetHistsAlgo::execute()", m_plots->execute(met,
                                                           eventWeight), "");

  return EL::StatusCode::SUCCESS;
}

EL::StatusCode MetHistsAlgo::postExecute() {
  return EL::StatusCode::SUCCESS;
}

EL::StatusCode MetHistsAlgo::finalize() {
  return EL::StatusCode::SUCCESS;
}
