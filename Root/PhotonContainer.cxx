...
PhotonContainer::PhotonContainer(const std::string& name,
...
void PhotonContainer::FillPhoton(const xAOD::IParticle *particle)
{
  ...
  if (m_infoSwitch.m_isolation) {
    static SG::AuxElement::Accessor<char> isIsoCone40CaloOnlyAcc(
      "isIsolated_FixedCutTightCaloOnly");
    safeFill<char, int, xAOD::Photon>(photon,
                                      isIsoCone40CaloOnlyAcc,
                                      m_isIsolated_Cone40CaloOnly,
                                      -1);

    static SG::AuxElement::Accessor<char> isIsoCone40Acc(
    ...
    static SG::AuxElement::Accessor<char> isIsoCone20Acc(
    ...
    m_topoetcone20->push_back(photon->isolation(xAOD::Iso::topoetcone20) /
                              m_units);
    m_topoetcone30->push_back(photon->isolation(xAOD::Iso::topoetcone30) /
                              m_units);
    m_topoetcone40->push_back(photon->isolation(xAOD::Iso::topoetcone40) /
                              m_units);
  }
  ...
  if (m_infoSwitch.m_effSF && m_mc) {
    static SG::AuxElement::Accessor<float> PhotonID_Tight_EffSF(
      "PhotonID_Tight_EffSF");
    static SG::AuxElement::Accessor<float> PhotonID_Medium_EffSF(
      "PhotonID_Medium_EffSF");
    static SG::AuxElement::Accessor<float> PhotonID_Loose_EffSF(
      "PhotonID_Loose_EffSF");

    static SG::AuxElement::Accessor<float> PhotonID_Tight_EffSF_Error(
      "PhotonID_Tight_EffSF_Error");
    static SG::AuxElement::Accessor<float> PhotonID_Medium_EffSF_Error(
      "PhotonID_Medium_EffSF_Error");
    static SG::AuxElement::Accessor<float> PhotonID_Loose_EffSF_Error(
      "PhotonID_Loose_EffSF_Error");
  ...
  if (m_infoSwitch.m_trigger) {
    static SG::AuxElement::Accessor<std::vector<std::string> > trigMatched(
      "trigMatched");
