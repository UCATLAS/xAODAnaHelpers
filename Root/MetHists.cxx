...
StatusCode MetHists::initialize() {
  m_metFinalClus = book(m_name,
                        "metFinalClus",
                        "metFinalClus",
                        100,
                        0,
                        200);
  m_metFinalClusPx = book(m_name,
                          "metFinalClusPx",
                          "metFinalClusPx",
                          100,
                          -200,
                          200);
  m_metFinalClusPy = book(m_name,
                          "metFinalClusPy",
                          "metFinalClusPy",
                          100,
                          -200,
                          200);
  m_metFinalClusSumEt = book(m_name,
                             "metFinalClusSumEt",
                             "metFinalClusSumEt",
                             100,
                             0,
                             2000);
  m_metFinalClusPhi = book(m_name,
                           "metFinalClusPhi",
                           "metFinalClusPhi",
                           100,
                           -3.2,
  ...
  m_metFinalTrk = book(m_name,
                       "metFinalTrk",
                       "metFinalTrk",
                       100,
                       0,
                       200);
  m_metFinalTrkPx = book(m_name,
                         "metFinalTrkPx",
                         "metFinalTrkPx",
                         100,
                         -200,
                         200);
  m_metFinalTrkPy = book(m_name,
                         "metFinalTrkPy",
                         "metFinalTrkPy",
                         100,
                         -200,
                         200);
  m_metFinalTrkSumEt = book(m_name,
                            "metFinalTrkSumEt",
                            "metFinalTrkSumEt",
                            100,
                            0,
                            2000);
  m_metFinalTrkPhi = book(m_name,
                          "metFinalTrkPhi",
                          "metFinalTrkPhi",
                          100,
                          -3.2,
...
StatusCode MetHists::execute(const xAOD::MissingETContainer *met,
                             float                           eventWeight) {
  if (m_debug) std::cout << "MetHists: in execute " << std::endl;

  //
  // ("FinalClus" uses the calocluster-based soft terms, "FinalTrk" uses the
  // track-based ones)
  //
