...
EL::StatusCode ElectronEfficiencyCorrector::initialize() {
    ...
    return EL::StatusCode::SUCCESS;
} // ElectronEfficiencyCorrector::initialize
...
EL::StatusCode ElectronEfficiencyCorrector::execute() {
    ...
    if(!m_isMC) {
        if(m_numEvent == 1) Info("execute()", "Sample is Data! Do not apply any Electron Efficiency correction... "); return EL::StatusCode::SUCCESS;
    }

    if(m_debug) Info("execute()", "Applying Electron Efficiency Correction... "); const xAOD::EventInfo* eventInfo(nullptr);
    ...
    return EL::StatusCode::SUCCESS;
} // ElectronEfficiencyCorrector::execute
...
EL::StatusCode ElectronEfficiencyCorrector::executeSF(const xAOD::ElectronContainer* inputElectrons, unsigned int countSyst) {
    ...
    return EL::StatusCode::SUCCESS;
} // ElectronEfficiencyCorrector::executeSF
