...
StatusCode VtxHists::initialize() {
  ...
  if (m_detailStr.find("TrkDetails") != std::string::npos) {
    ...
    h_trk_Pt         = book(m_name,
                            "trkPt",
                            "trkPt",
                            100,
                            -0.5,
                            9.5);
    h_trk_Pt_l = book(m_name,
                      "trkPt_l",
                      "trkPt",
                      100,
                      -0.5,
    ...
    h_pt_miss_x = book(m_name,
                       "Pt_miss_x",
                       "Pt_miss_x",
                       100,
                       -5.5,
                       4.5);
    h_pt_miss_x_l = book(m_name,
                         "Pt_miss_x_l",
                         "Pt_miss_x_l",
                         100,
                         -50.5,
    ...
    h_pt_miss_y = book(m_name,
                       "Pt_miss_y",
                       "Pt_miss_y",
                       100,
                       -5.5,
                       4.5);
    h_pt_miss_y_l = book(m_name,
                         "Pt_miss_y_l",
                         "Pt_miss_y_l",
                         100,
                         -50.5,
    ...
    h_pt_miss = book(m_name,
                     "Pt_miss",
                     "Pt_miss",
                     100,
                     -0.5,
                     9.5);
    h_pt_miss_l = book(m_name,
                       "Pt_miss_l",
                       "Pt_miss_l",
                       100,
                       -0.5,
  ...
  if (m_detailStr.find("IsoTrkDetails") != std::string::npos) {
    ...
    h_trkIsoAll = book(m_name,
                       "ptCone20All",
                       "ptCone20All",
                       100,
                       -0.5,
                       9.5);
    h_trkIso = book(m_name,
                    "ptCone20",
                    "ptCone20",
                    100,
                    -0.5,
    ...
    h_nIsoTrks = book(m_name,
                      "nIsoTrks",
                      "nIsoTrks",
                      100,
                      -0.5,
                      99.5);
    h_nIsoTrks_l = book(m_name,
                        "nIsoTrks_l",
                        "nIsoTrks",
                        100,
                        -0.5,
    ...
    h_IsoTrk_Pt = book(m_name,
                       "isoTrkPt",
                       "IsoTrkPt",
                       100,
                       -0.5,
                       9.5);
    h_IsoTrk_Pt_l = book(m_name,
                         "isoTrkPt_l",
                         "IsoTrkPt",
                         100,
                         -0.5,
    ...
    h_pt_miss_iso_x = book(m_name,
                           "Pt_miss_iso_x",
                           "Pt_miss_x",
                           100,
                           -5.5,
                           4.5);
    h_pt_miss_iso_x_l = book(m_name,
                             "Pt_miss_iso_x_l",
                             "Pt_miss_x_l",
                             100,
                             -50.5,
    ...
    h_pt_miss_iso_y = book(m_name,
                           "Pt_miss_iso_y",
                           "Pt_miss_y",
                           100,
                           -5.5,
                           4.5);
    h_pt_miss_iso_y_l = book(m_name,
                             "Pt_miss_iso_y_l",
                             "Pt_miss_y_l",
                             100,
                             -50.5,
    ...
    h_pt_miss_iso = book(m_name,
                         "Pt_miss_iso",
                         "Pt_miss",
                         100,
                         -0.5,
                         9.5);
    h_pt_miss_iso_l = book(m_name,
                           "Pt_miss_iso_l",
                           "Pt_miss_l",
                           100,
                           -0.5,
    ...
    h_nIsoTrks1GeV = book(m_name,
                          "nIsoTracks1GeV",
                          "nIsoTracks1GeV",
                          100,
                          -0.5,
                          99.5);
    h_nIsoTrks2GeV = book(m_name,
                          "nIsoTracks2GeV",
                          "nIsoTracks2GeV",
                          100,
                          -0.5,
                          99.5);
    h_nIsoTrks5GeV = book(m_name,
                          "nIsoTracks5GeV",
                          "nIsoTracks5GeV",
                          100,
                          -0.5,
                          99.5);
    h_nIsoTrks10GeV = book(m_name,
                           "nIsoTracks10GeV",
                           "nIsoTracks10GeV",
                           100,
                           -0.5,
                           99.5);
    h_nIsoTrks15GeV = book(m_name,
                           "nIsoTracks15GeV",
                           "nIsoTracks15GeV",
                           100,
                           -0.5,
                           99.5);
    h_nIsoTrks20GeV = book(m_name,
                           "nIsoTracks20GeV",
                           "nIsoTracks20GeV",
                           100,
                           -0.5,
                           99.5);
    h_nIsoTrks25GeV = book(m_name,
                           "nIsoTracks25GeV",
                           "nIsoTracks25GeV",
                           100,
                           -0.5,
                           99.5);
    h_nIsoTrks30GeV = book(m_name,
                           "nIsoTracks30GeV",
                           "nIsoTracks30GeV",
                           100,
                           -0.5,
    ...
    for (uint iLeadTrks = 0; iLeadTrks < m_nLeadIsoTrackPts; ++iLeadTrks) {
      std::stringstream ss;
      ss << iLeadTrks;
      h_IsoTrk_max_Pt.push_back(book(m_name, "IsoTrkPt_" + ss.str(),
                                     "IsoTrkPt(" + ss.str() + ")",    100,   -0.5,
                                     9.5));
      h_IsoTrk_max_Pt_l.push_back(book(m_name, "IsoTrkPt_" + ss.str() + "_l",
                                       "IsoTrkPt(" + ss.str() + ")",    100,
                                       -0.5,   99.5));
    }
  }
  ...
  if (m_detailStr.find("TrkPtDetails") != std::string::npos) {
    ...
    h_nTrks1GeV        = book(m_name,
                              "nTracks1GeV",
                              "nTracks1GeV",
                              100,
                              -0.5,
                              99.5);
    h_nTrks2GeV = book(m_name,
                       "nTracks2GeV",
                       "nTracks2GeV",
                       100,
                       -0.5,
                       99.5);
    h_nTrks5GeV = book(m_name,
                       "nTracks5GeV",
                       "nTracks5GeV",
                       100,
                       -0.5,
                       99.5);
    h_nTrks10GeV = book(m_name,
                        "nTracks10GeV",
                        "nTracks10GeV",
                        100,
                        -0.5,
                        99.5);
    h_nTrks15GeV = book(m_name,
                        "nTracks15GeV",
                        "nTracks15GeV",
                        100,
                        -0.5,
                        99.5);
    h_nTrks20GeV = book(m_name,
                        "nTracks20GeV",
                        "nTracks20GeV",
                        100,
                        -0.5,
                        99.5);
    h_nTrks25GeV = book(m_name,
                        "nTracks25GeV",
                        "nTracks25GeV",
                        100,
                        -0.5,
                        99.5);
    h_nTrks30GeV = book(m_name,
                        "nTracks30GeV",
                        "nTracks30GeV",
                        100,
                        -0.5,
    ...
    for (uint iLeadTrks = 0; iLeadTrks < m_nLeadTrackPts; ++iLeadTrks) {
      std::stringstream ss;
      ss << iLeadTrks;
      h_trk_max_Pt.push_back(book(m_name, "trkPt_" + ss.str(),
                                  "trkPt(" + ss.str() + ")",    100,   -0.5,
                                  9.5));
      h_trk_max_Pt_l.push_back(book(m_name, "trkPt_" + ss.str() + "_l",
                                    "trkPt(" + ss.str() + ")",    100,   -0.5,
                                    99.5));
    }
  }
...
StatusCode VtxHists::execute(const xAOD::VertexContainer *vtxs,
                             float                        eventWeight) {
...
StatusCode VtxHists::execute(const xAOD::VertexContainer        *vtxs,
                             ...
                             float                               eventWeight) {
  for (auto vtx_itr :  *vtxs) {
    RETURN_CHECK("VtxHists::execute()", this->execute(vtx_itr,
                                                      trks,
                                                      eventWeight), "");
  }
...
StatusCode VtxHists::execute(const xAOD::Vertex                 *vtx,
                             const xAOD::TrackParticleContainer *trks,
                             float                               eventWeight) {
  ...
  if (m_fillIsoTrkDetails) {
    ...
    for (uint iLeadTrks = 0; iLeadTrks < m_nLeadIsoTrackPts; ++iLeadTrks) {
      float this_pt =
        (pt_iso_vec.size() > iLeadTrks) ? pt_iso_vec.at(iLeadTrks) : 0;
    ...
    float pt_miss_iso = sqrt(
      pt_miss_iso_x * pt_miss_iso_x + pt_miss_iso_y * pt_miss_iso_y);
...
float VtxHists::getIso(const xAOD::TrackParticle          *inTrack,
                       const xAOD::TrackParticleContainer *trks,
                       float                               z0_cut,
                       float                               cone_size)
{
