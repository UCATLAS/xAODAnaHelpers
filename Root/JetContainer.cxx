...
JetContainer::JetContainer(const std::string& name,
...

{
  ...
  if (m_infoSwitch.m_allTrack) {
    ...
    if (m_infoSwitch.m_allTrackDetail) {
      m_GhostTrack_nPixelHits =
        new std::vector<std::vector<int> >();
      m_GhostTrack_nSCTHits =
        new std::vector<std::vector<int> >();
      m_GhostTrack_nTRTHits =
        new std::vector<std::vector<int> >();
      m_GhostTrack_nPixelSharedHits =
        new std::vector<std::vector<int> >();
      m_GhostTrack_nPixelSplitHits =
        new std::vector<std::vector<int> >();
      m_GhostTrack_nInnermostPixelLayerHits =
        new std::vector<std::vector<int> >();
      m_GhostTrack_nInnermostPixelLayerSharedHits =
        new std::vector<std::vector<int> >();
      m_GhostTrack_nInnermostPixelLayerSplitHits =
        new std::vector<std::vector<int> >();
      m_GhostTrack_nNextToInnermostPixelLayerHits =
        new std::vector<std::vector<int> >();
      m_GhostTrack_nNextToInnermostPixelLayerSharedHits =
        new std::vector<std::vector<int> >();
      m_GhostTrack_nNextToInnermostPixelLayerSplitHits =
        new std::vector<std::vector<int> >();
    }
  }
...
void JetContainer::setTree(TTree *tree, const std::string& tagger)
{
  ...
  if (m_infoSwitch.m_clean)
  {
    ...
    connectBranch<float>(tree, "LArBadHVEnergyFrac",
                         &m_LArBadHVEnergyFrac);
    connectBranch<float>(tree, "OotFracClusters5", &m_OotFracClusters5);
    connectBranch<float>(tree, "OotFracClusters10",
                         &m_OotFracClusters10);
    connectBranch<float>(tree, "LeadingClusterPt", &m_LeadingClusterPt);
    connectBranch<float>(tree,
                         "LeadingClusterSecondLambda",
                         &m_LeadingClusterSecondLambda);
    connectBranch<float>(tree,
                         "LeadingClusterCenterLambda",
                         &m_LeadingClusterCenterLambda);
    connectBranch<float>(tree,
                         "LeadingClusterSecondR",
                         &m_LeadingClusterSecondR);
    connectBranch<int>(  tree, "clean_passLooseBad",
                         &m_clean_passLooseBad);
    connectBranch<int>(  tree,
                         "clean_passLooseBadUgly",
                         &m_clean_passLooseBadUgly);
    connectBranch<int>(  tree, "clean_passTightBad",
                         &m_clean_passTightBad);
    connectBranch<int>(  tree,
                         "clean_passTightBadUgly",
                         &m_clean_passTightBadUgly);
  }
  ...
  if (m_infoSwitch.m_JVC)
  {
    connectBranch<double>(tree,
                          "JetVertexCharge_discriminant",
                          &m_JetVertexCharge_discriminant);
  }
  ...
  if (m_infoSwitch.m_jetFitterDetails)
  {
    ...
    connectBranch<float>(tree,
                         ...
                         &m_JetFitter_nSingleTracks);
    connectBranch<float>(tree,
                         "JetFitter_nTracksAtVtx",
                         &m_JetFitter_nTracksAtVtx);
    connectBranch<float>(tree, "JetFitter_mass", &m_JetFitter_mass);
    connectBranch<float>(tree,
                         "JetFitter_energyFraction",
                         &m_JetFitter_energyFraction);
    connectBranch<float>(tree,
                         "JetFitter_significance3d",
                         &m_JetFitter_significance3d);
  ...
  if (m_infoSwitch.m_ipDetails) {
    ...
    connectBranch<vector<float> >(tree,
                                  "IP2D_gradeOfTracks",
                                  &m_IP2D_gradeOfTracks);
    connectBranch<vector<float> >(tree,
                                  "IP2D_flagFromV0ofTracks",
                                  &m_IP2D_flagFromV0ofTracks);
    connectBranch<vector<float> >(tree,
                                  "IP2D_valD0wrtPVofTracks",
                                  &m_IP2D_valD0wrtPVofTracks);
    connectBranch<vector<float> >(tree,
    ...
    connectBranch<vector<float> >(tree,
                                  ...
                                  &m_IP3D_valD0wrtPVofTracks);
    connectBranch<vector<float> >(tree,
                                  "IP3D_sigD0wrtPVofTracks",
                                  &m_IP3D_sigD0wrtPVofTracks);
    connectBranch<vector<float> >(tree,
                                  "IP3D_valZ0wrtPVofTracks",
                                  &m_IP3D_valZ0wrtPVofTracks);
    connectBranch<vector<float> >(tree,
                                  "IP3D_sigZ0wrtPVofTracks",
                                  &m_IP3D_sigZ0wrtPVofTracks);
    connectBranch<vector<float> >(tree,
  ...
  if (m_infoSwitch.m_truth)
  {
    ...
    connectBranch<float>(tree,
                         "TruthLabelDeltaR_B",
                         &m_TruthLabelDeltaR_B);
    connectBranch<float>(tree,
                         "TruthLabelDeltaR_C",
                         &m_TruthLabelDeltaR_C);
    connectBranch<float>(tree,
                         "TruthLabelDeltaR_T",
                         &m_TruthLabelDeltaR_T);
    connectBranch<int>(  tree,
                         "PartonTruthLabelID",
                         &m_PartonTruthLabelID);
    connectBranch<float>(tree,
                         "GhostTruthAssociationFraction",
                         &m_GhostTruthAssociationFraction);
...
void JetContainer::setBranches(TTree *tree)
{
  ...
  if (m_infoSwitch.m_clean) {
    ...
    setBranch<int>(  tree, "clean_passLooseBadUgly",
                     m_clean_passLooseBadUgly);
    setBranch<int>(  tree, "clean_passTightBad",    m_clean_passTightBad);
    setBranch<int>(  tree, "clean_passTightBadUgly",
                     m_clean_passTightBadUgly);
  }
  ...
  if (m_infoSwitch.m_trackPV) {
    ...
    // setBranch<float>(tree,"GhostTrackAssociationFraction",
    // m_ghostTrackAssFrac);
  }


  if (m_infoSwitch.m_allTrack) {
    // if want to apply the selection of the PV then need to setup track
    // selection tool
    ...
    if (m_infoSwitch.m_allTrackPVSel) {
      ...
      // RETURN_CHECK( "HelpTreeBase::JetTrackSelection",
      // m_trkSelTool->initialize(), "");
    }
    ...
    if (m_infoSwitch.m_allTrackDetail) {
      setBranch<vector<int> >(tree,
                              "GhostTrack_nPixelHits",
                              m_GhostTrack_nPixelHits);
      setBranch<vector<int> >(tree,
                              "GhostTrack_nSCTHits",
                              m_GhostTrack_nSCTHits);
      setBranch<vector<int> >(tree,
                              ...
                              m_GhostTrack_nTRTHits);
      setBranch<vector<int> >(tree,
                              "GhostTrack_nPixelSharedHits",
                              m_GhostTrack_nPixelSharedHits);
      setBranch<vector<int> >(tree,
                              "GhostTrack_nPixelSplitHits",
                              m_GhostTrack_nPixelSplitHits);
      setBranch<vector<int> >(tree,
                              "m_GhostTrack_nInnermostPixelLayerHits",
                              m_GhostTrack_nInnermostPixelLayerHits);
  ...
  if (m_infoSwitch.m_flavTag  || m_infoSwitch.m_flavTagHLT) {
    ...
    if (m_infoSwitch.m_jetFitterDetails) {
      ...
      setBranch<float>(tree, "JetFitter_nSingleTracks",
                       m_JetFitter_nSingleTracks);
      setBranch<float>(tree, "JetFitter_nTracksAtVtx",
                       m_JetFitter_nTracksAtVtx);
  ...
  if (!m_infoSwitch.m_sfFTagFix.empty()) {
    if (findBTagSF(m_infoSwitch.m_sfFTagFix, 30)) m_btag_Fix30->setBranch(tree,
                                                                          m_name);



    if (findBTagSF(m_infoSwitch.m_sfFTagFix, 50)) m_btag_Fix50->setBranch(tree,
                                                                          m_name);



    if (findBTagSF(m_infoSwitch.m_sfFTagFix, 60)) m_btag_Fix60->setBranch(tree,
                                                                          m_name);



    if (findBTagSF(m_infoSwitch.m_sfFTagFix, 70)) m_btag_Fix70->setBranch(tree,
                                                                          m_name);



    if (findBTagSF(m_infoSwitch.m_sfFTagFix, 77)) m_btag_Fix77->setBranch(tree,
                                                                          m_name);



    if (findBTagSF(m_infoSwitch.m_sfFTagFix, 80)) m_btag_Fix80->setBranch(tree,
                                                                          m_name);


    if (findBTagSF(m_infoSwitch.m_sfFTagFix, 85)) m_btag_Fix85->setBranch(tree,
                                                                          m_name);


    if (findBTagSF(m_infoSwitch.m_sfFTagFix, 90)) m_btag_Fix90->setBranch(tree,
                                                                          m_name);
  ...
  if (!m_infoSwitch.m_sfFTagFlt.empty()) {
    if (findBTagSF(m_infoSwitch.m_sfFTagFlt, 30)) m_btag_Flt30->setBranch(tree,
      m_name);
...
void JetContainer::FillJet(const xAOD::IParticle *particle, const xAOD::Vertex *pv, int pvLocation) {
  ...
  if (m_infoSwitch.m_scales) {
    ...
    if (status) m_emScalePt->push_back(fourVec.Pt() / m_units); else m_emScalePt->push_back(-999);                        //
                                                                                                                          //
                                                                                                                          //
                                                                                                                          // Constit
                                                                                                                          //
    ...
    if (status) m_constScalePt->push_back(fourVec.Pt() / m_units); else m_constScalePt->push_back(-999);                  //
                                                                                                                          //
                                                                                                                          //
                                                                                                                          // Pileup
                                                                                                                          //
    ...
    if (status) m_pileupScalePt->push_back(fourVec.Pt() / m_units); else m_pileupScalePt->push_back(-999);                //
                                                                                                                          //
                                                                                                                          //
                                                                                                                          // OriginConstit
                                                                                                                          //
    ...
    if (status) m_originConstitScalePt->push_back(fourVec.Pt() / m_units); else m_originConstitScalePt->push_back(-999);  //
                                                                                                                          //
                                                                                                                          //
                                                                                                                          // EtaJES
                                                                                                                          //
    ...
    if (status) m_etaJESScalePt->push_back(fourVec.Pt() / m_units); else m_etaJESScalePt->push_back(-999);                //
                                                                                                                          //
                                                                                                                          //
                                                                                                                          // GSC
                                                                                                                          //
    ...
    if (status) m_gscScalePt->push_back(fourVec.Pt() / m_units); else m_gscScalePt->push_back(-999);                      //
                                                                                                                          //
                                                                                                                          //
                                                                                                                          // only
                                                                                                                          //
    ...
    if (status) m_insituScalePt->push_back(fourVec.Pt() / m_units); else m_insituScalePt->push_back(-999);
  }
  ...
  if (m_infoSwitch.m_constscaleEta) {
    ...
    if (status) m_constScaleEta->push_back(fourVec.Eta()); else m_constScaleEta->push_back(-999);
  }
  ...
  if (m_infoSwitch.m_trackAll || m_infoSwitch.m_trackPV) {
    ...
    if (m_infoSwitch.m_trackPV && (pvLocation >= 0)) {
      ...
      //      static SG::AuxElement::ConstAccessor<float>
      // ghostTrackAssFrac("GhostTrackAssociationFraction");
  ...
  if (m_infoSwitch.m_allTrack) {
    ...
    if (ghostTrack.isAvailable(*jet)) {
      ...
      for (auto link_itr : trackLinks) {
        if (!link_itr.isValid()) continue; const xAOD::TrackParticle *track = dynamic_cast<const xAOD::TrackParticle *>(*link_itr);
        ...
        if (m_infoSwitch.m_allTrackPVSel) {
          ...
          if (!m_trkSelTool->accept(*track, pv)) continue;                                          //
                                                                                                    //
                                                                                                    //
                                                                                                    // ID
                                                                                                    //
          ...
          if (track->vertex() != pv) {                                                              //
            ...
            if (fabs((track->z0() + track->vz() - pv->z()) * sin(track->theta())) > 3.0) continue;  //
                                                                                                    //
                                                                                                    //
                                                                                                    // make
                                                                                                    //
        ...
        z0.push_back(track->z0() + track->vz() - pv->z()); // store z0 wrt
                                                           // PV...most useful
  ...
  if (m_infoSwitch.m_flavTag || m_infoSwitch.m_flavTagHLT) {
    ...
    if (m_infoSwitch.m_jetFitterDetails) {
      ...
      // static SG::AuxElement::ConstAccessor< double > jf_pb
      //           ("JetFitterCombNN_pb");
      // safeFill<double, float, xAOD::BTagging>(myBTag, jf_pb, m_JetFitter_pb,
      // -999);
      //
      // static SG::AuxElement::ConstAccessor< double > jf_pc
      //           ("JetFitterCombNN_pc");
      // safeFill<double, float, xAOD::BTagging>(myBTag, jf_pc, m_JetFitter_pc,
      // -999);
      //
      // static SG::AuxElement::ConstAccessor< double > jf_pu
      //           ("JetFitterCombNN_pu");
      // safeFill<double, float, xAOD::BTagging>(myBTag, jf_pu, m_JetFitter_pu,
      // -999);
    }
  ...
  if (m_infoSwitch.m_truthDetails) {
    ...
    //    static SG::AuxElement::ConstAccessor< std::vector<const
    // xAOD::TruthParticle*> > ghostPartons("GhostPartons");
    //    if( ghostPartons.isAvailable( *jet )) {
    //    std::vector<const xAOD::TruthParticle*> truthPartons = ghostPartons(
    // *jet );
    ...
    if (truthPartons.size() == 0) {
      ...
      for (unsigned int i = 1; i < truthPartons.size(); ++i) {
        if ((truthPartons.at(i)->pt() > 0.001) && (truthPartons.at(i)->e() > truthPartons.at(iParent)->e())) iParent = i;
      }
