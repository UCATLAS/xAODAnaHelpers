...
TLorentzVector MuonInFatJetCorrection::getHbbCorrectedVector(const xAOD::Jet& jet)
{
  /* Steps:
...
EL::StatusCode MuonInFatJetCorrection::decorateWithMuons(const xAOD::Jet& jet) const
{
...
const xAOD::JetFourMom_t MuonInFatJetCorrection::getMuonCorrectedJetFourMom(const xAOD::Jet &jet, std::vector<const xAOD::Muon*> muons, Scheme scheme, bool useJMSScale) const
{
