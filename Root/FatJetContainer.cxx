...
FatJetContainer::FatJetContainer(const std::string& name,
  ...
  m_trackJetEtaCut(2.5)
{
  ...
  if (m_infoSwitch.m_VTags) {
    m_WbosonTaggerMedium = new JetSubStructureUtils::BosonTag("medium",
                                                              "smooth",
                                                              "$ROOTCOREBIN/data/JetSubStructureUtils/config_13TeV_Wtagging_MC15_Prerecommendations_20150809.dat",
                                                              false,
                                                              false);
    m_ZbosonTaggerMedium = new JetSubStructureUtils::BosonTag("medium",
                                                              "smooth",
                                                              "$ROOTCOREBIN/data/JetSubStructureUtils/config_13TeV_Ztagging_MC15_Prerecommendations_20150809.dat",
                                                              false,
                                                              false);

    m_WbosonTaggerTight = new JetSubStructureUtils::BosonTag("tight",
                                                             "smooth",
                                                             "$ROOTCOREBIN/data/JetSubStructureUtils/config_13TeV_Wtagging_MC15_Prerecommendations_20150809.dat",
                                                             false,
                                                             false);
    m_ZbosonTaggerTight = new JetSubStructureUtils::BosonTag("tight",
                                                             "smooth",
                                                             "$ROOTCOREBIN/data/JetSubStructureUtils/config_13TeV_Ztagging_MC15_Prerecommendations_20150809.dat",
                                                             false,
                                                             false);
  ...
  if (m_infoSwitch.m_trackJets) {
    ...
    m_trkJets   =
      new xAH::JetContainer(trkJetName,
                            "kinematic flavorTag constituent sfFTagFix77",
                            m_units,
                            m_mc);
...
void FatJetContainer::setTree(TTree *tree)
{
  ...
  if (m_infoSwitch.m_scales) {
    connectBranch<float>(tree,
                         ...
                         &m_JetConstitScaleMomentum_eta);
    connectBranch<float>(tree,
                         "JetConstitScaleMomentum_phi",
                         &m_JetConstitScaleMomentum_phi);
    connectBranch<float>(tree,
                         "JetConstitScaleMomentum_m",
                         &m_JetConstitScaleMomentum_m);
    connectBranch<float>(tree,
                         "JetConstitScaleMomentum_pt",
                         &m_JetConstitScaleMomentum_pt);
    ...
    connectBranch<float>(tree,
                         ...
                         &m_JetEMScaleMomentum_phi);
    connectBranch<float>(tree,
                         "JetEMScaleMomentum_m",
                         &m_JetEMScaleMomentum_m);
    connectBranch<float>(tree,
                         "JetEMScaleMomentum_pt",
                         &m_JetEMScaleMomentum_pt);
  }
...
void FatJetContainer::setBranches(TTree *tree)
{
  ...
  if (m_infoSwitch.m_scales) {
    ...
    setBranch<float>(tree, "JetEMScaleMomentum_eta",
                     m_JetEMScaleMomentum_eta);
    setBranch<float>(tree, "JetEMScaleMomentum_phi",
                     m_JetEMScaleMomentum_phi);
    setBranch<float>(tree, "JetEMScaleMomentum_m", m_JetEMScaleMomentum_m);
    setBranch<float>(tree, "JetEMScaleMomentum_pt",
                     m_JetEMScaleMomentum_pt);
  }
...
void FatJetContainer::FillFatJet(const xAOD::IParticle *particle) {
  ...
  if (m_infoSwitch.m_scales) {
    static SG::AuxElement::ConstAccessor<float> acc_JetConstitScaleMomentum_eta(
      "JetConstitScaleMomentum_eta");
    safeFill<float, float, xAOD::Jet>(fatjet,
                                      acc_JetConstitScaleMomentum_eta,
                                      m_JetConstitScaleMomentum_eta,
                                      -999);
    static SG::AuxElement::ConstAccessor<float> acc_JetConstitScaleMomentum_phi(
      "JetConstitScaleMomentum_phi");
    safeFill<float, float, xAOD::Jet>(fatjet,
                                      acc_JetConstitScaleMomentum_phi,
                                      m_JetConstitScaleMomentum_phi,
                                      -999);
    static SG::AuxElement::ConstAccessor<float> acc_JetConstitScaleMomentum_m(
      "JetConstitScaleMomentum_m");
    safeFill<float, float, xAOD::Jet>(fatjet,
                                      acc_JetConstitScaleMomentum_m,
                                      m_JetConstitScaleMomentum_m,
                                      -999,
                                      m_units);
    static SG::AuxElement::ConstAccessor<float> acc_JetConstitScaleMomentum_pt(
      "JetConstitScaleMomentum_pt");
    safeFill<float, float, xAOD::Jet>(fatjet,
                                      acc_JetConstitScaleMomentum_pt,
                                      m_JetConstitScaleMomentum_pt,
                                      -999,
                                      m_units);

    static SG::AuxElement::ConstAccessor<float> acc_JetEMScaleMomentum_eta(
      "JetEMScaleMomentum_eta");
    safeFill<float, float, xAOD::Jet>(fatjet,
                                      acc_JetEMScaleMomentum_eta,
                                      m_JetEMScaleMomentum_eta,
                                      -999);
    static SG::AuxElement::ConstAccessor<float> acc_JetEMScaleMomentum_phi(
      "JetEMScaleMomentum_phi");
    safeFill<float, float, xAOD::Jet>(fatjet,
                                      acc_JetEMScaleMomentum_phi,
                                      m_JetEMScaleMomentum_phi,
                                      -999);
    static SG::AuxElement::ConstAccessor<float> acc_JetEMScaleMomentum_m(
      "JetEMScaleMomentum_m");
    safeFill<float, float, xAOD::Jet>(fatjet,
                                      acc_JetEMScaleMomentum_m,
                                      m_JetEMScaleMomentum_m,
                                      -999,
                                      m_units);
    static SG::AuxElement::ConstAccessor<float> acc_JetEMScaleMomentum_pt(
      "JetEMScaleMomentum_pt");
    safeFill<float, float, xAOD::Jet>(fatjet,
                                      acc_JetEMScaleMomentum_pt,
                                      m_JetEMScaleMomentum_pt,
                                      -999,
                                      m_units);
  }
  ...
  if (m_infoSwitch.m_area) {
    ...
    safeFill<float, float, xAOD::Jet>(fatjet,
                                      ...
                                      m_VoronoiArea,
                                      -999);
    static SG::AuxElement::ConstAccessor<float> acc_ActiveArea4vec_pt(
      "ActiveArea4vec_pt");
    safeFill<float, float, xAOD::Jet>(fatjet,
                                      acc_ActiveArea4vec_pt,
                                      m_ActiveArea4vec_pt,
                                      -999,
                                      m_units);
    static SG::AuxElement::ConstAccessor<float> acc_ActiveArea4vec_eta(
      "ActiveArea4vec_eta");
    safeFill<float, float, xAOD::Jet>(fatjet,
                                      acc_ActiveArea4vec_eta,
                                      m_ActiveArea4vec_eta,
                                      -999);
    static SG::AuxElement::ConstAccessor<float> acc_ActiveArea4vec_phi(
      "ActiveArea4vec_phi");
    safeFill<float, float, xAOD::Jet>(fatjet,
                                      acc_ActiveArea4vec_phi,
                                      m_ActiveArea4vec_phi,
                                      -999);
    static SG::AuxElement::ConstAccessor<float> acc_ActiveArea4vec_m(
      "ActiveArea4vec_m");
    safeFill<float, float, xAOD::Jet>(fatjet,
                                      acc_ActiveArea4vec_m,
                                      m_ActiveArea4vec_m,
                                      -999,
                                      m_units);
  }
  ...
  if (m_infoSwitch.m_substructure) {
    ...
    } else if (acc_tau1_wta.isAvailable(*fatjet) &&
               acc_tau2_wta.isAvailable(*fatjet)) {
    ...
    } else if (acc_tau2_wta.isAvailable(*fatjet) &&
               acc_tau3_wta.isAvailable(*fatjet)) {
    ...
    safeFill<int, int, xAOD::Jet>(fatjet, acc_NClusters, m_NClusters,
                                  -999);
    ...
    safeFill<int, float, xAOD::Jet>(fatjet, NTrimSubjets, m_NTrimSubjets,
                                    -999);
    ...
    } else if (acc_ECF1.isAvailable(*fatjet) && acc_ECF2.isAvailable(*fatjet) &&
               acc_ECF3.isAvailable(*fatjet)) {
      float e2 = (acc_ECF2(*fatjet) / (acc_ECF1(*fatjet) * acc_ECF1(*fatjet)));
      float e3 =
        (acc_ECF3(*fatjet) /
         (acc_ECF1(*fatjet) * acc_ECF1(*fatjet) * acc_ECF1(*fatjet)));
    ...
    if (acc_C2.isAvailable(*fatjet)) {
      m_C2->push_back(acc_C2(*fatjet));
               ...
               acc_ECF3.isAvailable(*fatjet)) {
      m_C2->push_back(acc_ECF3(*fatjet) * acc_ECF1(*fatjet) /
                      pow(acc_ECF2(*fatjet), 2.0));
  ...
  if (m_infoSwitch.m_constituentAll) {
    m_constituentWeights->push_back(fatjet->getAttribute<std::vector<float> >(
                                      "constituentWeights"));
    std::vector<float> pt;
  ...
  if (m_infoSwitch.m_bosonCount) {
    ...
    try {
      ...
      Warning("executeSingle()",
              "Unable to get parent jet of fat-jet for truth labeling. Trimmed jet area would be used!");
      fatJetParentJet = fatjet;
    }

    if (m_mc) {
      static SG::AuxElement::ConstAccessor<int> truthfatjet_TQuarks(
        "GhostTQuarksFinalCount");
      safeFill<int, int, xAOD::Jet>(fatJetParentJet,
                                    truthfatjet_TQuarks,
                                    m_nTQuarks,
                                    -999);

      static SG::AuxElement::ConstAccessor<int> truthfatjet_WBosons(
        "GhostWBosonsCount");
      safeFill<int, int, xAOD::Jet>(fatJetParentJet,
                                    truthfatjet_WBosons,
                                    m_nWBosons,
      ...
      static SG::AuxElement::ConstAccessor<int> truthfatjet_ZBosons(
        "GhostZBosonsCount");
      safeFill<int, int, xAOD::Jet>(fatJetParentJet,
                                    truthfatjet_ZBosons,
                                    m_nZBosons,
      ...
      static SG::AuxElement::ConstAccessor<int> truthfatjet_HBosons(
        "GhostHBosonsCount");
      safeFill<int, int, xAOD::Jet>(fatJetParentJet,
                                    truthfatjet_HBosons,
                                    m_nHBosons,
  ...
  if (m_infoSwitch.m_trackJets) {
    ...
    try {
      ...
      Warning("execute()",
              "Unable to fetch \"Parent\" link from leading calo-jet");
    }
    ...
    try {
      assotrkjets = fatjet_parent->getAssociatedObjects<xAOD::Jet>(
        m_infoSwitch.m_trackJetName);
    }
    catch (...) {
      Warning("execute()",
              "Unable to fetch \"%s\" link from leading calo-jet",
              m_infoSwitch.m_trackJetName.data());
    }
