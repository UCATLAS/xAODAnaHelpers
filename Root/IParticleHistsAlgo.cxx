...
EL::StatusCode IParticleHistsAlgo::AddHists(std::string name) {
  ...
  IParticleHists *particleHists = new IParticleHists(fullname,
                                                     m_detailStr,
                                                     m_histPrefix,
                                                     m_histTitle); // add
                                                                   // systematic
...
EL::StatusCode IParticleHistsAlgo::fileExecute() {
  return EL::StatusCode::SUCCESS;
}

EL::StatusCode IParticleHistsAlgo::changeInput(bool /*firstFile*/) {
  return EL::StatusCode::SUCCESS;
}
...
EL::StatusCode IParticleHistsAlgo::initialize()
{
  ...
  if (m_inputAlgo.empty()) AddHists(""); m_event = wk()->xaodEvent();
...
EL::StatusCode IParticleHistsAlgo::postExecute() {
  return EL::StatusCode::SUCCESS;
}
